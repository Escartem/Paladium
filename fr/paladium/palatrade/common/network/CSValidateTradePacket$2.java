...
class null implements CresusCallback<CresusResponse> {
  public void onSuccess(CresusResponse response) {
    CresusManager.getInstance().depositPlayer(player.func_110124_au(), targetTrade.getMoney(), "Trade -> " + target.func_70005_c_() + " (" + target.func_110124_au().toString() + ")");
  }
