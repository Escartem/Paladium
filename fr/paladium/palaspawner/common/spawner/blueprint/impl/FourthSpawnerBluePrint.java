  ...
  protected void init() {
    addFloors(new Floor[] { Floor.create()
          .addPatterns(new String[] { 
              "O O       O O", "    O   O    ", "O           O", "   O SPS O   ", " O  OSOSO  O ", "   SSOOOSS   ", "   POOXOOP   ", "   SSOOOSS   ", " O  OSOSO  O ", "   O S S O   ", 
              "O           O", "    O   O    ", "O O       O O" }), Floor.create()
          .addPatterns(new String[] { 
              "O O       O O", "    O   O    ", "O           O", "   G     G   ", " O         O ", "             ", "             ", "             ", " O         O ", "   G     G   ", 
              "O           O", "    O   O    ", "O O       O O" }), Floor.create()
          .addPatterns(new String[] { 
    ...
    addRecipes(new StructureRecipe[] { StructureRecipe.create('P', Blocks.field_150402_ci), 
          ...
          StructureRecipe.create('E', (Block)SpawnerBlockRegistry.SPAWNER_STRUCTURE_THREE) });
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palaspawner\common\spawner\blueprint\impl\FourthSpawnerBluePrint.class
