package fr.paladium.palaclicker.server.command.set;
...
public class ClickerSetSubCommand extends ASubCommand {
  public ClickerSetSubCommand() {
    ABaseSubCommand sub = PlayerSubCommand.create("(player)").build(this);
    NumberSubCommand.create("(amount)", "set player coins", Integer.valueOf(0), Integer.valueOf(2147483647)).build((ASubCommand)sub, (sender, data) -> {
...
/* Location:              E:\Paladium\!\fr\paladium\palaclicker\server\command\set\ClickerSetSubCommand.class
