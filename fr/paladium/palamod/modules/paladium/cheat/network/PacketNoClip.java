...
public class PacketNoClip implements IMessage {
  boolean noClip;
  
  public PacketNoClip() {}
  
  public PacketNoClip(boolean noClip) {
    this.noClip = noClip;
  }
  ...
  public static class Handler implements IMessageHandler<PacketNoClip, IMessage> {
