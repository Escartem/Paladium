...
public class PacketOnlineDetector implements IMessage {
  String player;
  ...
  public static class Handler implements IMessageHandler<PacketOnlineDetector, IMessage> {
