...
public class ItemTankPistol extends Item {
  ...
  public ItemStack func_77659_a(ItemStack p_77659_1_, World p_77659_2_, EntityPlayer p_77659_3_) {
    ...
    if (movingobjectposition.field_72313_a == MovingObjectPosition.MovingObjectType.BLOCK) {
      ...
      if (!p_77659_2_.func_72962_a(p_77659_3_, i, j, k) || !EventUtils.canInteract(p_77659_3_, i, j, k))
        return p_77659_1_; 
      if (flag) {
  ...
  private boolean hasMatchingTank(EntityPlayer p, String liquid, boolean needToBeNotFull) {
    for (int i = 0; i < p.field_71071_by.field_70462_a.length; i++) {
      ...
      if (is != null && is.func_77973_b() != null && Block.func_149634_a(is.func_77973_b()) instanceof BlockTank && is.field_77994_a == 1)
        if (BlockTank.getLiquid(is).equalsIgnoreCase(liquid) || (!BlockTank.getLiquid(is).isEmpty() && "*".equalsIgnoreCase(liquid))) {
  ...
  public boolean tryPlaceContainedLiquid(EntityPlayer p, World p_77875_1_, int p_77875_2_, int p_77875_3_, int p_77875_4_) {
    ...
    if (blockSulfuricWater == null || (!p_77875_1_.func_147437_c(p_77875_2_, p_77875_3_, p_77875_4_) && !flag))
      return false; 
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\paladium\common\items\eventcommu\ItemTankPistol.class
