...
public class CSPacketAncientHammerValidateFortuneUI implements IMessage {
  private boolean success;
  
  public CSPacketAncientHammerValidateFortuneUI() {}
  
  public CSPacketAncientHammerValidateFortuneUI(boolean success) {
  ...
  @PacketHandler
  public static class Handler implements IMessageHandler<CSPacketAncientHammerValidateFortuneUI, IMessage> {
