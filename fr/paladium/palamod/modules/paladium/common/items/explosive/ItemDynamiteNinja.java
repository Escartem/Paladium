...
public class ItemDynamiteNinja extends BaseItemDynamite {
  public ItemDynamiteNinja(String unlocalizedName, String texture) {
  ...
  public ItemStack func_77659_a(ItemStack itemstack, World world, EntityPlayer entityplayer) {
    ...
    if (entityplayer.field_71071_by.func_146026_a((Item)this) && 
      !world.field_72995_K) {
      world.func_72838_d((Entity)new DynamiteNinjaEntity(world, (EntityLivingBase)entityplayer, 40 + Item.field_77697_d.nextInt(10), DynamiteEntity.NINJA));
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\paladium\common\items\explosive\ItemDynamiteNinja.class
