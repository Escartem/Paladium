...
public class BlockLavaSponge extends BlockGeneric implements ITooltipWiki {
  public BlockLavaSponge() {
    super(Material.field_151583_m, new String[] { "", "wet" });
    func_149663_c("lava_sponge");
    func_149658_d("palamod:lava_sponge");
    func_149711_c(0.6F);
  ...
  protected void tryAbsorb(World worldIn, int x, int y, int z, boolean wet) {
    if (!wet && absorb(worldIn, x, y, z)) {
      ...
      worldIn.func_72926_e(2001, x, y, z, Block.func_149682_b(Blocks.field_150353_l));
    } 
  }
  ...
  private boolean absorb(World world, int x, int y, int z) {
    ...
    while (!linkedlist.isEmpty()) {
      ...
      for (ForgeDirection dir : ForgeDirection.VALID_DIRECTIONS) {
        ...
        if (world.func_147439_a(blockpos2.x, blockpos2.y, blockpos2.z).func_149688_o() == Material.field_151587_i) {
  ...
  public void func_149734_b(World world, int x, int y, int z, Random rand) {
    if (world.func_72805_g(x, y, z) == 1) {
      ...
      if (dir != ForgeDirection.UP && !World.func_147466_a((IBlockAccess)world, x + dir.offsetX, y + dir.offsetY, z + dir.offsetZ)) {
        ...
        world.func_72869_a("dripLava", d0, d1, d2, 0.0D, 0.0D, 0.0D);
      } 
    } 
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\paladium\common\blocks\BlockLavaSponge.class
