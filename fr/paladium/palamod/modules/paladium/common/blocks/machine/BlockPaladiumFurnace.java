...
public class BlockPaladiumFurnace extends BlockContainer implements ITooltipWiki {
  ...
  public TileEntity func_149915_a(World world, int metadata) {
    return (TileEntity)new PaladiumFurnaceLogic();
  }
  
  public boolean func_149727_a(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
    if (!world.field_72995_K)
      player.openGui(PalaMod.instance, PGuiRegistry.GUI_PALADIUM_FURNACE, world, x, y, z); 
    return true;
  }
  ...
  public void func_149651_a(IIconRegister iiconRegister) {
    this
      .field_149761_L = iiconRegister.func_94245_a("palamod:machines/paladium_furnace_side");
    this
      .front = iiconRegister.func_94245_a(this.isActive ? "palamod:machines/paladium_furnace_front_on" : "palamod:machines/paladium_furnace_front_off");
  }
  ...
  public IIcon func_149691_a(int side, int metadata) {
    if (metadata == 0 && side == 3)
      return this.front; 
    return (side != metadata) ? this.field_149761_L : this.front;
  }
  
  public Item func_149650_a(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
    return Item.func_150898_a((Block)BlocksRegister.PALADIUM_FURNACE);
  }
  ...
  public static void updateFurnaceBlockState(boolean burning, World world, int x, int y, int z) {
    ...
    isBurning = true;
    if (burning) {
      world.func_147449_b(x, y, z, (Block)BlocksRegister.LIT_PALADIUM_FURNACE);
    } else {
      world.func_147449_b(x, y, z, (Block)BlocksRegister.PALADIUM_FURNACE);
    } 
    isBurning = false;
  ...
  public void func_149749_a(World world, int x, int y, int z, Block block, int meta) {
    if (!isBurning) {
      PaladiumFurnaceLogic tileentitytutfurnace = (PaladiumFurnaceLogic)world.func_147438_o(x, y, z);
      if (tileentitytutfurnace != null) {
        for (int i = 0; i < tileentitytutfurnace.func_70302_i_(); i++) {
          ...
          if (itemstack != null) {
            float f = world.field_73012_v.nextFloat() * 0.6F + 0.1F;
            float f1 = world.field_73012_v.nextFloat() * 0.6F + 0.1F;
            float f2 = world.field_73012_v.nextFloat() * 0.6F + 0.1F;
            while (itemstack.field_77994_a > 0) {
              ...
              EntityItem entityitem = new EntityItem(world, (x + f), (y + f1), (z + f2), new ItemStack(itemstack.func_77973_b(), j, itemstack.func_77960_j()));
  ...
  public String getUrl(ItemStack arg0) {
    return "https://wiki.paladium-pvp.fr/items-et-machines/items-du-palamod/les-machines#13.-palafurnace";
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\paladium\common\blocks\machine\BlockPaladiumFurnace.class
