...
public class DynamiteEndiumEntity extends EntityArrow implements IThrowableEntity {
  ...
  public DynamiteEndiumEntity(World world) {
    super(world);
    this.xTile = -1;
    this.yTile = -1;
    this.zTile = -1;
  ...
  public DynamiteEndiumEntity(World world, double d, double d1, double d2) {
    this(world);
    func_70107_b(d, d1, d2);
  }
  
  public DynamiteEndiumEntity(World world, EntityLivingBase entityliving, int i, int type) {
    this(world);
    this.type = type;
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\paladium\common\entities\projectiles\DynamiteEndiumEntity.class
