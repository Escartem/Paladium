...
public class DynamiteEntity extends EntityArrow implements IThrowableEntity {
  ...
  private void detonate() {
    ...
    float f = 3.0F;
    if (this.type == BIG) {
      getEntityData().func_74757_a("canExplodeCanon", true);
      f = 4.5F;
    } 
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\paladium\common\entities\projectiles\DynamiteEntity.class
