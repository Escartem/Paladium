...
public class AlchemyCreatorArrowContainer extends PaladiumContainer {
  private final InventoryPlayer inventory;
  
  private final AlchemyCreatorLogic tile;
  
  public AlchemyCreatorArrowContainer(SimpleGHandler.GuiHandlerData data) {
  ...
  public AlchemyCreatorArrowContainer(AlchemyCreatorLogic tile, EntityPlayer player) {
    ...
    this.tile = tile;
    func_75146_a(new Slot((IInventory)tile, 4, 55, 15));
    func_75146_a(new Slot((IInventory)tile, 5, 79, 15));
    func_75146_a(new Slot((IInventory)tile, 6, 103, 15));
    func_75146_a(new Slot((IInventory)tile, 7, 79, 37));
    func_75146_a(new Slot((IInventory)tile, 8, 79, 59));
    bindPlayerInventory();
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\paladium\common\container\AlchemyCreatorArrowContainer.class
