...
public class RenderDynamite extends Render {
  ...
  public void renderDynamite(DynamiteEntity e, double d, double d1, double d2, float f, float f1) {
    try {
      ...
      System.out.println("Oups une erreur est survenue lors du load du render de la dynamite, Message: " + exception.getMessage());
    } 
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\paladium\client\render\RenderDynamite.class
