...
public class RenderDynamiteEndium extends Render {
  private static final ResourceLocation textureDynamite = new ResourceLocation("palamod:textures/entity/dynamite_endium.png");
  ...
  public RenderDynamiteEndium(int type) {
    this.pitch = 40.0F;
    this.type = type;
  }
  
  public void renderDynamite(DynamiteEndiumEntity e, double d, double d1, double d2, float f, float f1) {
    try {
      GL11.glPushMatrix();
      ...
      System.out.println("Oups une erreur est survenue lors du load du render de l'endium dynamite, Message: " + exception.getMessage());
    } 
  }
  
  public void func_76986_a(Entity entity, double d, double d1, double d2, float f, float f1) {
    renderDynamite((DynamiteEndiumEntity)entity, d, d1, d2, f, f1);
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\paladium\client\render\RenderDynamiteEndium.class
