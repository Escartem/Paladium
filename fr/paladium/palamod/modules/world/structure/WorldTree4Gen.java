...
public class WorldTree4Gen extends WorldGenerator {
  private Block LEAVES;
  
  private Block WOOD;
  
  public WorldTree4Gen(Block leaves, Block wood) {
    this.LEAVES = leaves;
    this.WOOD = wood;
  }
  
  public boolean func_76484_a(World world, Random random, int x, int y, int z) {
    world.func_147449_b(x + -4, y + 9, z + 0, this.LEAVES);
    ...
    world.func_147449_b(x + -3, y + 10, z + 0, this.LEAVES);
    ...
    world.func_147449_b(x + -1, y + 9, z + 2, this.LEAVES);
    world.func_147449_b(x + -1, y + 9, z + 3, this.WOOD);
    world.func_147449_b(x + -1, y + 9, z + 5, this.LEAVES);
    ...
    world.func_147449_b(x + 0, y + 2, z + -1, this.WOOD);
    world.func_147449_b(x + 0, y + 2, z + 3, this.WOOD);
    world.func_147449_b(x + 0, y + 3, z + -1, this.WOOD);
    world.func_147449_b(x + 0, y + 3, z + 0, this.WOOD);
    world.func_147449_b(x + 0, y + 3, z + 2, this.WOOD);
    ...
    world.func_147449_b(x + 0, y + 7, z + -1, this.LEAVES);
    ...
    world.func_147449_b(x + 1, y + 1, z + -3, this.WOOD);
    world.func_147449_b(x + 1, y + 1, z + 3, this.WOOD);
    world.func_147449_b(x + 1, y + 1, z + 4, this.WOOD);
    world.func_147449_b(x + 1, y + 2, z + -2, this.WOOD);
    world.func_147449_b(x + 1, y + 2, z + 0, this.WOOD);
    world.func_147449_b(x + 1, y + 7, z + -2, this.LEAVES);
    world.func_147449_b(x + 1, y + 7, z + 0, this.LEAVES);
    world.func_147449_b(x + 1, y + 7, z + 1, this.WOOD);
    world.func_147449_b(x + 1, y + 7, z + 2, this.LEAVES);
    world.func_147449_b(x + 1, y + 8, z + -1, this.LEAVES);
    world.func_147449_b(x + 1, y + 8, z + 0, this.WOOD);
    world.func_147449_b(x + 1, y + 8, z + 1, this.LEAVES);
    world.func_147449_b(x + 1, y + 8, z + 4, this.LEAVES);
    world.func_147449_b(x + 1, y + 9, z + -2, this.LEAVES);
    world.func_147449_b(x + 1, y + 9, z + -1, this.WOOD);
    world.func_147449_b(x + 1, y + 9, z + 0, this.LEAVES);
    world.func_147449_b(x + 1, y + 9, z + 1, this.LEAVES);
    world.func_147449_b(x + 1, y + 9, z + 2, this.LEAVES);
    ...
    world.func_147449_b(x + 4, y + 8, z + 2, this.LEAVES);
    return true;
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\world\structure\WorldTree4Gen.class
