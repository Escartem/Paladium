...
class null implements CresusCallback<Boolean> {
  public void onSuccess(Boolean success) {
    if (!success.booleanValue()) {
      ShopManager.access$000(ShopManager.this, player);
      return;
    } 
    CresusManager.getInstance().withdrawPlayerAsync(player.func_110124_au(), price, "[AdminShop] Buy " + stack.func_77977_a() + " x" + amount, new CresusCallback<CresusResponse>() {
          public void onSuccess(CresusResponse response) {
            ...
            ShopManager.access$100(ShopManager.this, player, item, amount, price, true);
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\shop\api\ShopManager$4.class
