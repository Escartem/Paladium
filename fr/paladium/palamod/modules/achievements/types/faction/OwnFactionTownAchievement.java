...
public class OwnFactionTownAchievement extends Achievement {
  public static final int QUANTITY = 1;
  
  public static OwnFactionTownAchievementBuilder builder() {
    return new OwnFactionTownAchievementBuilder();
  }
  
  public static class OwnFactionTownAchievementBuilder {
    private String id;
  ...
  public OwnFactionTownAchievement(String id, AchievementCategory category, String name, String description, int quantityRequired, String icon) {
    super(id, category, name, description, quantityRequired, icon);
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\achievements\types\faction\OwnFactionTownAchievement.class
