...
public class EntityMagma extends EntityBossProjectiles {
  public EntityMagma(World p_i1753_1_) {
    super(p_i1753_1_);
    func_70105_a(2.0F, 2.0F);
  }
  
  public EntityMagma(World p_i1754_1_, double p_i1754_2_, double p_i1754_4_, double p_i1754_6_) {
    super(p_i1754_1_, p_i1754_2_, p_i1754_4_, p_i1754_6_);
    func_70105_a(2.0F, 2.0F);
  }
  
  public EntityMagma(World p_i1755_1_, EntityLivingBase p_i1755_2_, EntityLivingBase p_i1755_3_, Float p_i1755_4_, Float p_i1755_5_) {
    super(p_i1755_1_, p_i1755_2_, p_i1755_3_, p_i1755_4_, p_i1755_5_);
    func_70105_a(2.0F, 2.0F);
  }
  
  public EntityMagma(World p_i1756_1_, EntityLivingBase p_i1756_2_, EntityLivingBase p_i1755_3_, float p_i1756_3_, float p_i1755_5_, int rotationYaw, int rotationPitch) {
  ...
  public EntityMagma(World p_i1756_1_, EntityLivingBase p_i1756_2_, float p_i1756_3_) {
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\palaboss\common\entity\projectiles\EntityMagma.class
