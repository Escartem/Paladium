...
public class EruptionAttack extends DistancedAttack {
  ...
  public EruptionAttack(JsonObject jsonObject) {
    super("eruption");
  ...
  public void execute(final World world, final EntityBossBase entityHost, EntityLivingBase toAttackEntity) {
    ...
    for (int i = 0; i < 25 + world.field_73012_v.nextInt(25); i++) {
      int rotationYaw = world.field_73012_v.nextInt(180) + -90;
      rotationYaw = -rotationYaw;
      EntityMagma entityMagma = new EntityMagma(world, (EntityLivingBase)entityHost, toAttackEntity, 0.7F, (14 - world.field_73013_u.func_151525_a() * 4), rotationYaw, -(60 + world.field_73012_v.nextInt(30)));
      if (entityMagma instanceof EntityBossProjectiles)
        ((EntityBossProjectiles)entityMagma).setDamage(damage); 
      entityMagma.func_70015_d(60);
      world.func_72838_d((Entity)entityMagma);
    } 
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\palaboss\common\attacks\EruptionAttack.class
