...
import fr.paladium.palamod.modules.palaboss.client.models.ModelMorsula;
...
public class RenderMorsula extends RenderBiped {
  private static final ResourceLocation morsulaTexture = new ResourceLocation("palamod", "textures/entity/boss/morsula.png");
  
  public RenderMorsula() {
    super((ModelBiped)new ModelMorsula(), 0.05F);
    func_77042_a(this.field_77045_g);
  }
  
  protected ResourceLocation func_110775_a(Entity p_110775_1_) {
    return morsulaTexture;
  }
  
  protected void func_77041_b(EntityLivingBase p_77041_1_, float p_77041_2_) {
    EntityMorsula morsula = (EntityMorsula)p_77041_1_;
    float sizeMultiplier = BossRegistry.INSTANCE.getBossAttributes(morsula.getClass()).getAttributeInteger("sizeMultiplier", 1);
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\palaboss\client\renderer\RenderMorsula.class
