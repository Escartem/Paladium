...
import fr.paladium.palamod.modules.palaboss.client.models.ModelMagma;
import net.minecraft.client.renderer.entity.Render;
import net.minecraft.entity.Entity;
import net.minecraft.util.ResourceLocation;
import org.lwjgl.opengl.GL11;

public class RenderMagma extends Render {
  private ModelMagma model = new ModelMagma();
  
  private static final ResourceLocation magmaTexture = new ResourceLocation("palamod", "textures/entity/projectiles/magma.png");
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\palaboss\client\renderer\RenderMagma.class
