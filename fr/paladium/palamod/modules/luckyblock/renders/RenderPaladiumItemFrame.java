...
public class RenderPaladiumItemFrame extends Render {
  ...
  private static ModelItemFrame model = new ModelItemFrame();
  
  public static ModelItemFrame getModel() {
    return model;
  }
  ...
  public void doRender(EntityPaladiumItemFrame p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
    GL11.glPushMatrix();
    ...
    if (p_76986_1_.func_82335_i() != null && p_76986_1_
      .func_82335_i().func_77973_b() == Items.field_151098_aY) {
    ...
    GL11.glPopMatrix();
    func_147914_a(p_76986_1_, p_76986_2_ + (Direction.field_71583_a[p_76986_1_.field_82332_a] * 0.3F), p_76986_4_ - 0.25D, p_76986_6_ + (Direction.field_71581_b[p_76986_1_.field_82332_a] * 0.3F));
  }
  
  protected ResourceLocation getEntityTexture(EntityPaladiumItemFrame p_110775_1_) {
    return null;
  }
  
  private void func_147915_b(EntityPaladiumItemFrame p_147915_1_) {
    GL11.glPushMatrix();
    ...
    float f2 = f1 / 2.0F;
    GL11.glPushMatrix();
    this.field_147916_f.func_147770_b(0.0D, (0.5F - f2 + 0.0625F), (0.5F - f2 + 0.0625F), f, (0.5F + f2 - 0.0625F), (0.5F + f2 - 0.0625F));
    ...
    GL11.glPushMatrix();
    this.field_147916_f.func_147770_b(0.0D, (0.5F - f2), (0.5F - f2), (f + 1.0E-4F), (f + 0.5F - f2), (0.5F + f2));
    this.field_147916_f.func_147800_a(block, 0, 1.0F);
    GL11.glPopMatrix();
    GL11.glPushMatrix();
    this.field_147916_f.func_147770_b(0.0D, (0.5F + f2 - f), (0.5F - f2), (f + 1.0E-4F), (0.5F + f2), (0.5F + f2));
    this.field_147916_f.func_147800_a(block, 0, 1.0F);
    GL11.glPopMatrix();
    GL11.glPushMatrix();
    this.field_147916_f.func_147770_b(0.0D, (0.5F - f2), (0.5F - f2), f, (0.5F + f2), (f + 0.5F - f2));
    this.field_147916_f.func_147800_a(block, 0, 1.0F);
    GL11.glPopMatrix();
    GL11.glPushMatrix();
    this.field_147916_f.func_147770_b(0.0D, (0.5F - f2), (0.5F + f2 - f), f, (0.5F + f2), (0.5F + f2));
    this.field_147916_f.func_147800_a(block, 0, 1.0F);
    GL11.glPopMatrix();
    this.field_147916_f.func_147762_c();
    this.field_147916_f.func_147771_a();
  ...
  private void renderFrameItemAsBlock(EntityPaladiumItemFrame p_82403_1_) {
    GL11.glPushMatrix();
    ...
    float f1 = 0.75F;
    float f2 = f1 / 2.0F;
    GL11.glTranslated(0.0D, -1.0D, -0.05D);
    func_110776_a(texture);
    model.renderAll();
    GL11.glPopMatrix();
  }
  
  private void func_82402_b(EntityPaladiumItemFrame p_82402_1_) {
    ...
    if (itemstack != null) {
      ...
      GL11.glPushMatrix();
      GL11.glTranslatef(-0.453125F * Direction.field_71583_a[p_82402_1_.field_82332_a], -0.18F, -0.453125F * Direction.field_71581_b[p_82402_1_.field_82332_a]);
      GL11.glRotatef(180.0F + p_82402_1_.field_70177_z, 0.0F, 1.0F, 0.0F);
      GL11.glRotatef((-90 * p_82402_1_.func_82333_j()), 0.0F, 0.0F, 1.0F);
      ...
      if (item == Items.field_151098_aY) {
        ...
        if (item == Items.field_151111_aL) {
          ...
          TextureAtlasSprite textureatlassprite1 = ((TextureMap)texturemanager.func_110581_b(TextureMap.field_110576_c)).func_110572_b(Items.field_151111_aL
              .func_77650_f(entityitem.func_92059_d()).func_94215_i());
          if (textureatlassprite1 instanceof TextureCompass) {
            ...
            texturecompass.func_94241_a(p_82402_1_.field_70170_p, p_82402_1_.field_70165_t, p_82402_1_.field_70161_v, 
                
                MathHelper.func_76142_g((180 + p_82402_1_.field_82332_a * 90)), false, true);
            texturecompass.field_94244_i = d0;
            texturecompass.field_94242_j = d1;
          } 
        } 
        RenderItem.field_82407_g = true;
        RenderManager.field_78727_a.func_147940_a((Entity)entityitem, 0.0D, 0.0D, 0.0D, 0.0F, 0.0F);
        RenderItem.field_82407_g = false;
        if (item == Items.field_151111_aL) {
          TextureAtlasSprite textureatlassprite = ((TextureMap)Minecraft.func_71410_x().func_110434_K().func_110581_b(TextureMap.field_110576_c)).func_110572_b(Items.field_151111_aL
              .func_77650_f(entityitem.func_92059_d()).func_94215_i());
  ...
  protected void func_147914_a(EntityPaladiumItemFrame p_147914_1_, double p_147914_2_, double p_147914_4_, double p_147914_6_) {
    if (Minecraft.func_71382_s() && p_147914_1_.func_82335_i() != null && p_147914_1_
      .func_82335_i().func_82837_s() && this.field_76990_c.field_147941_i == p_147914_1_) {
      float f = 1.6F;
      float f1 = 0.016666668F * f;
      double d3 = p_147914_1_.func_70068_e((Entity)this.field_76990_c.field_78734_h);
      ...
      if (d3 < (f2 * f2)) {
        ...
        if (p_147914_1_.func_70093_af()) {
          ...
          func_147906_a((Entity)p_147914_1_, s, p_147914_2_, p_147914_4_, p_147914_6_, 64);
        } 
      } 
    } 
  }
  ...
  protected ResourceLocation func_110775_a(Entity p_110775_1_) {
    return getEntityTexture((EntityPaladiumItemFrame)p_110775_1_);
  }
  
  public void func_76986_a(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
    doRender((EntityPaladiumItemFrame)p_76986_1_, p_76986_2_, p_76986_4_, p_76986_6_, p_76986_8_, p_76986_9_);
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\renders\RenderPaladiumItemFrame.class
