...
public class ModelAngryWither extends ModelBase {
  ...
  public ModelAngryWither() {
    ...
    this.field_82905_a[1] = (new ModelRenderer(this))
      .func_78787_b(this.field_78090_t, this.field_78089_u);
  ...
  public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
    ...
    (this.field_82905_a[1]).field_78795_f = (0.065F + 0.05F * f6) * 3.1415927F;
    this.field_82905_a[2].func_78793_a(-2.0F, 6.9F + 
        MathHelper.func_76134_b((this.field_82905_a[1]).field_78795_f) * 10.0F, -0.5F + 
        MathHelper.func_76126_a((this.field_82905_a[1]).field_78795_f) * 10.0F);
    (this.field_82905_a[2]).field_78795_f = (0.265F + 0.1F * f6) * 3.1415927F;
  ...
  public void func_78086_a(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_) {
    EntityAngryWither entitywither = (EntityAngryWither)p_78086_1_;
    for (int i = 1; i < 3; i++) {
      (this.field_82904_b[i])
        .field_78796_g = (entitywither.func_82207_a(i - 1) - p_78086_1_.field_70761_aq) / 57.295776F;
      (this.field_82904_b[i])
        .field_78795_f = entitywither.func_82210_r(i - 1) / 57.295776F;
    } 
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\renders\models\ModelAngryWither.class
