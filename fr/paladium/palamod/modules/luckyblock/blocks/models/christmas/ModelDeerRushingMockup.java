...
public class ModelDeerRushingMockup extends ModelBase {
  ...
  public ModelDeerRushingMockup() {
    this.field_78090_t = 64;
    this.field_78089_u = 64;
    this.DEER = new ModelRenderer(this);
    this.DEER.func_78793_a(1.0F, 10.0F, 1.0F);
    setRotationAngle(this.DEER, -1.5708F, -1.4399F, 1.5708F);
    ...
    setRotationAngle(this.DEER_LEG_FRONT_RIGHT, 0.0F, 0.0F, 0.6545F);
    ...
    setRotationAngle(this.DEER_LEG_FRONT_LEFT, 0.0F, 0.0F, 0.9599F);
    ...
    setRotationAngle(this.cube_r2, 0.0F, 0.0F, -0.829F);
    ...
    setRotationAngle(this.DEER_BACK, 0.0F, 0.0F, 0.1309F);
    ...
    setRotationAngle(this.DEER_LEG_BACK_RIGHT, 0.0F, 0.0F, 0.2182F);
    ...
    setRotationAngle(this.cube_r4, 0.0F, 0.0F, -0.6545F);
    ...
    setRotationAngle(this.DEER_LEG_BACK_LEFT, 0.0F, 0.0F, -0.1309F);
    ...
    setRotationAngle(this.DEER_HEAD, 0.0F, 0.0F, 0.0436F);
    ...
    this.cube_r5.func_78793_a(1.0339F, -9.1241F, -2.0179F);
    this.DEER_HEAD.func_78792_a(this.cube_r5);
    setRotationAngle(this.cube_r5, 0.0F, 0.2182F, 0.0F);
    this.cube_r5.field_78804_l.add(new ModelBox(this.cube_r5, 0, 56, -4.0F, -8.0F, 0.0F, 16, 8, 0, 0.0F));
    this.cube_r6 = new ModelRenderer(this);
    this.cube_r6.func_78793_a(1.0339F, -9.1241F, 1.9821F);
    ...
    this.cube_r7.func_78793_a(2.0339F, -9.3741F, -2.5179F);
    this.DEER_HEAD.func_78792_a(this.cube_r7);
    setRotationAngle(this.cube_r7, 0.5236F, 0.0F, 0.0F);
    this.cube_r7.field_78804_l.add(new ModelBox(this.cube_r7, 19, 14, -1.0F, -2.75F, -0.5F, 2, 3, 1, 0.0F));
    this.cube_r8 = new ModelRenderer(this);
    this.cube_r8.func_78793_a(2.0339F, -9.1241F, 2.4821F);
    this.DEER_HEAD.func_78792_a(this.cube_r8);
    setRotationAngle(this.cube_r8, -0.5236F, 0.0F, 0.0F);
    this.cube_r8.field_78804_l.add(new ModelBox(this.cube_r8, 19, 14, -1.0F, -3.0F, -0.5F, 2, 3, 1, 0.0F));
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\blocks\models\christmas\ModelDeerRushingMockup.class
