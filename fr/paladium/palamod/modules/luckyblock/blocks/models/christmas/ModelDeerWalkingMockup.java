...
public class ModelDeerWalkingMockup extends ModelBase {
  ...
  public ModelDeerWalkingMockup() {
    ...
    setRotationAngle(this.DEER_LEG_FRONT_RIGHT, -0.0231F, 0.0094F, 0.3962F);
    ...
    this.DEER_LEG_FRONT_RIGHT.func_78792_a(this.cube_r1);
    setRotationAngle(this.cube_r1, 0.0F, 0.0F, -0.5672F);
    this.cube_r1.field_78804_l.add(new ModelBox(this.cube_r1, 48, 33, -2.0F, 0.0F, -2.0F, 4, 7, 4, 0.0F));
    ...
    setRotationAngle(this.DEER_LEG_FRONT_LEFT, 0.0F, 0.0F, -0.1745F);
    ...
    this.DEER_LEG_FRONT_LEFT.func_78792_a(this.cube_r2);
    setRotationAngle(this.cube_r2, 0.0F, 0.0F, 0.0873F);
    this.cube_r2.field_78804_l.add(new ModelBox(this.cube_r2, 48, 33, -2.0F, 0.0F, -2.0F, 4, 7, 4, 0.0F));
    ...
    this.cube_r3.func_78793_a(10.0F, -7.0F, -2.0F);
    this.DEER_BACK.func_78792_a(this.cube_r3);
    setRotationAngle(this.cube_r3, 0.0F, 0.0F, -0.3927F);
    this.cube_r3.field_78804_l.add(new ModelBox(this.cube_r3, 52, 14, -2.75F, -0.5F, 0.0F, 2, 4, 2, 0.0F));
    ...
    setRotationAngle(this.DEER_LEG_BACK_RIGHT, 0.0F, 0.0F, 0.0873F);
    this.DEER_LEG_BACK_RIGHT.field_78804_l.add(new ModelBox(this.DEER_LEG_BACK_RIGHT, 48, 22, -2.0F, -0.25F, -2.0F, 4, 6, 4, 0.0F));
    this.cube_r4 = new ModelRenderer(this);
    this.cube_r4.func_78793_a(0.0F, 5.75F, 0.0F);
    this.DEER_LEG_BACK_RIGHT.func_78792_a(this.cube_r4);
    setRotationAngle(this.cube_r4, 0.0F, 0.0F, 0.0873F);
    this.cube_r4.field_78804_l.add(new ModelBox(this.cube_r4, 48, 33, -2.0F, 0.0F, -2.0F, 4, 7, 4, 0.0F));
    ...
    setRotationAngle(this.DEER_LEG_BACK_LEFT, 0.0F, 0.0F, -0.2182F);
    this.DEER_LEG_BACK_LEFT.field_78804_l.add(new ModelBox(this.DEER_LEG_BACK_LEFT, 48, 22, -2.0F, -0.25F, -2.0F, 4, 6, 4, 0.0F));
    this.cube_r5 = new ModelRenderer(this);
    this.cube_r5.func_78793_a(0.0F, 5.75F, 0.0F);
    this.DEER_LEG_BACK_LEFT.func_78792_a(this.cube_r5);
    setRotationAngle(this.cube_r5, 0.0F, 0.0F, -0.4363F);
    this.cube_r5.field_78804_l.add(new ModelBox(this.cube_r5, 48, 33, -2.0F, 0.0F, -2.0F, 4, 7, 4, 0.0F));
    ...
    this.cube_r6.func_78793_a(1.0339F, -9.1241F, -2.0179F);
    this.DEER_HEAD.func_78792_a(this.cube_r6);
    setRotationAngle(this.cube_r6, 0.0F, 0.2182F, 0.0F);
    this.cube_r6.field_78804_l.add(new ModelBox(this.cube_r6, 0, 56, -4.0F, -8.0F, 0.0F, 16, 8, 0, 0.0F));
    this.cube_r7 = new ModelRenderer(this);
    this.cube_r7.func_78793_a(1.0339F, -9.1241F, 1.9821F);
    this.DEER_HEAD.func_78792_a(this.cube_r7);
    setRotationAngle(this.cube_r7, 0.0F, -0.2182F, 0.0F);
    this.cube_r7.field_78804_l.add(new ModelBox(this.cube_r7, 0, 56, -4.0F, -8.0F, 0.0F, 16, 8, 0, 0.0F));
    this.cube_r8 = new ModelRenderer(this);
    this.cube_r8.func_78793_a(2.0339F, -9.3741F, -2.5179F);
    this.DEER_HEAD.func_78792_a(this.cube_r8);
    setRotationAngle(this.cube_r8, 0.5236F, 0.0F, 0.0F);
    this.cube_r8.field_78804_l.add(new ModelBox(this.cube_r8, 19, 14, -1.0F, -2.75F, -0.5F, 2, 3, 1, 0.0F));
    this.cube_r9 = new ModelRenderer(this);
    this.cube_r9.func_78793_a(2.0339F, -9.1241F, 2.4821F);
    this.DEER_HEAD.func_78792_a(this.cube_r9);
    setRotationAngle(this.cube_r9, -0.5236F, 0.0F, 0.0F);
    this.cube_r9.field_78804_l.add(new ModelBox(this.cube_r9, 19, 14, -1.0F, -3.0F, -0.5F, 2, 3, 1, 0.0F));
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\blocks\models\christmas\ModelDeerWalkingMockup.class
