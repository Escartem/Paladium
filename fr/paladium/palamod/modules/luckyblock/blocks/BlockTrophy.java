...
public class BlockTrophy extends BlockTrophyBase {
  public BlockTrophy() {
    func_149647_a(PLuckyBlock.TAB);
    func_149663_c("trophy");
    func_149676_a(0.3F, 0.0F, 0.3F, 0.7F, 1.0F, 0.7F);
    func_149658_d("palamod:trophy/TrophyTier0");
    func_149711_c(1.0F);
  }
  ...
  public void func_149689_a(World world, int x, int y, int z, EntityLivingBase player, ItemStack item) {
    ...
    TileEntityTrophy tile = (TileEntityTrophy)world.func_147438_o(x, y, z);
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    if (!world.field_72995_K) {
      TileEntityTrophy te = (TileEntityTrophy)world.func_147438_o(x, y, z);
      if (te != null) {
  ...
  public int func_149645_b() {
    return ClientProxy.renderTrophy;
  }
  ...
  public TileEntity createTileEntity(World world, int metadata) {
    return (TileEntity)new TileEntityTrophy();
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\blocks\BlockTrophy.class
