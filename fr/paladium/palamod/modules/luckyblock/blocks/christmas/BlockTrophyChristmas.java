...
public class BlockTrophyChristmas extends BlockTrophyBase {
  public BlockTrophyChristmas() {
    func_149663_c("trophychristmas");
    func_149658_d("palamod:trophy/christmas/texture");
  }
  ...
  public void func_149689_a(World world, int x, int y, int z, EntityLivingBase player, ItemStack item) {
    ...
    TileEntityTrophyChristmas tile = (TileEntityTrophyChristmas)world.func_147438_o(x, y, z);
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    if (!world.field_72995_K) {
      TileEntityTrophyChristmas te = (TileEntityTrophyChristmas)world.func_147438_o(x, y, z);
      if (te != null) {
  ...
  public int func_149645_b() {
    return ClientProxy.renderTrophyChristmas;
  }
  ...
  public TileEntity createTileEntity(World world, int metadata) {
    return (TileEntity)new TileEntityTrophyChristmas();
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\blocks\christmas\BlockTrophyChristmas.class
