...
public class BlockJuneTrophy extends BlockTrophyBase {
  public BlockJuneTrophy() {
    func_149663_c("june_trophy");
    func_149658_d("palamod:trophy/june/june_trophy");
  }
  ...
  public TileEntity createTileEntity(World world, int metadata) {
    return (TileEntity)new TileEntityJuneTrophy();
  }
  ...
  public void func_149689_a(World world, int x, int y, int z, EntityLivingBase player, ItemStack item) {
    ...
    TileEntityJuneTrophy tile = (TileEntityJuneTrophy)world.func_147438_o(x, y, z);
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    if (!world.field_72995_K && EventUtils.canInteract(player, x, y, z)) {
      TileEntityJuneTrophy te = (TileEntityJuneTrophy)world.func_147438_o(x, y, z);
      if (te != null) {
  ...
  public int func_149645_b() {
    return ClientProxy.renderJuneTrophy;
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\blocks\june\BlockJuneTrophy.class
