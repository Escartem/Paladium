...
public class BlockMayTrophy extends BlockTrophyBase {
  public BlockMayTrophy() {
    func_149663_c("may_trophy");
    func_149658_d("palamod:trophy/may/may_trophy");
  }
  ...
  public TileEntity createTileEntity(World world, int metadata) {
    return (TileEntity)new TileEntityMayTrophy();
  }
  ...
  public void func_149689_a(World world, int x, int y, int z, EntityLivingBase player, ItemStack item) {
    ...
    TileEntityMayTrophy tile = (TileEntityMayTrophy)world.func_147438_o(x, y, z);
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    if (!world.field_72995_K && EventUtils.canInteract(player, x, y, z)) {
      TileEntityMayTrophy te = (TileEntityMayTrophy)world.func_147438_o(x, y, z);
      if (te != null) {
  ...
  public int func_149645_b() {
    return ClientProxy.renderMayTrophy;
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\blocks\may\BlockMayTrophy.class
