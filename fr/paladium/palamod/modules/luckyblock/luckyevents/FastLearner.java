...
public class FastLearner extends ALuckyEvent {
  public void perform(EntityPlayerMP player, int x, int y, int z) {
    ...
    PlayerUtils.sendActionBar(player, "§aWaw ! Tu as gagné 5 niveau en §e" + job.getName());
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\luckyevents\FastLearner.class
