...
public class CoffreMai extends ALuckyEvent {
          ...
          public void run() {
            try {
              ...
              if (isOpened) {
                ...
                chest.func_70299_a(0, new ItemStack(BlocksRegister.DIGICODE, 3));
                chest.func_70299_a(1, new ItemStack(BlocksRegister.BLOCK_PALADIUM, 3));
                chest.func_70299_a(2, new ItemStack(Blocks.field_150340_R, 10));
                chest.func_70299_a(3, new ItemStack(BlocksRegister.BLOCK_GPALADIUM, 2));
                chest.func_70299_a(4, new ItemStack(BlocksRegister.STONE_HEARTH, 1));
  ...
  public String getTexture() {
    return "may/coffre_mai";
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\luckyevents\may\CoffreMai.class
