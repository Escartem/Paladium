...
public enum LuckyType {
  PALADIUM("LuckyBlock en Paladium"),
  ENDIUM("LuckyBlock en Endium"),
  FINDIUM("LuckyBlock en Findium"),
  BLACK("LuckyBlock Noir"),
  MARCH("LuckyBlock de Mars"),
  EASTER("LuckyBlock de Paques"),
  MAY("LuckyBlock de Mai"),
  JUNE("LuckyBlock de Juin"),
  JULY("LuckyBlock de Juillet"),
  AUGUST("LuckyBlock d'Aout"),
  SEPTEMBER("LuckyBlock de Septembre"),
  HALLOWEEN("LuckyBlock d'Halloween"),
  NOVEMBER("LuckyBlock de Novembre"),
  CHRISTMAS("LuckyBlock de Noël");
  
  private final String text;
  
  public static final List<LuckyType> disabledLuckyType;
  
  LuckyType(String text) {
    this.text = text;
  }
  ...
  static {
    disabledLuckyType = Arrays.asList(new LuckyType[] { ENDIUM });
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckybloc\\utils\LuckyType.class
