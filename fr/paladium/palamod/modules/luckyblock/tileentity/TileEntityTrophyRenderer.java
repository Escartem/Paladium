...
import fr.paladium.palamod.modules.luckyblock.blocks.models.ModelTrophy;
...
public class TileEntityTrophyRenderer extends TileEntitySpecialRenderer {
  private static ModelTrophy model = new ModelTrophy();
  
  public static ModelTrophy getModel() {
    return model;
  }
  ...
  public TileEntityTrophyRenderer() {
    for (int i = 0; i < textures.length; i++)
      textures[i] = new ResourceLocation("palamod", "textures/blocks/trophy/TrophyTier" + i + ".png"); 
  }
  
  public void func_147500_a(TileEntity te, double x, double y, double z, float ticks) {
    renderBlockTileEntityAt((TileEntityTrophy)te, x, y, z, ticks);
  }
  ...
  private void renderBlockTileEntityAt(TileEntityTrophy tile, double x, double y, double z, float ticks) {
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\tileentity\TileEntityTrophyRenderer.class
