...
public class TrophyCommand extends CommandBase {
  ...
  public void func_71515_b(ICommandSender sender, String[] args) {
    if (sender instanceof EntityPlayerMP && args.length == 2) {
      ...
      try {
        ...
        if (level >= 0 && level < 4) {
          ItemStack item = new ItemStack(BlocksRegister.TROPHY, 1, level);
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\commands\luckystats\TrophyCommand.class
