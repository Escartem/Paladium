...
public class PacketGetLuckyPass implements IMessage {
  private int[] wins;
  
  public PacketGetLuckyPass() {}
  
  public PacketGetLuckyPass(int[] wins) {
    this.wins = wins;
  }
  ...
  public void toBytes(ByteBuf buf) {
    if (this.wins == null || this.wins.length == 0)
      return; 
    for (int win : this.wins)
      buf.writeInt(win); 
  }
  
  public static class Handler implements IMessageHandler<PacketGetLuckyPass, IMessage> {
    public IMessage onMessage(PacketGetLuckyPass message, MessageContext ctx) {
      ...
      ((UILuckyPass)(Minecraft.func_71410_x()).field_71462_r).setData(message.wins);
      return null;
    }
  }
}
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\network\luckypass\PacketGetLuckyPass.class
