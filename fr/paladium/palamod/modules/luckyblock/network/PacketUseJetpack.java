...
public class PacketUseJetpack implements IMessage {
  public boolean reset;
  
  public PacketUseJetpack() {
    this(false);
  }
  
  public PacketUseJetpack(boolean reset) {
    this.reset = reset;
  }
  ...
  public static class Handler implements IMessageHandler<PacketUseJetpack, IMessage> {
