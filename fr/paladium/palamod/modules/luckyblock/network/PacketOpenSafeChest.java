...
public class PacketOpenSafeChest implements IMessage {
  private int x;
  ...
  public PacketOpenSafeChest() {}
  
  public PacketOpenSafeChest(int x, int y, int z, String code) {
    this.x = x;
    this.y = y;
    this.z = z;
    this.code = code;
  ...
  public static class Handler implements IMessageHandler<PacketOpenSafeChest, IMessage> {
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\network\PacketOpenSafeChest.class
