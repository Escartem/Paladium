...
public class Handler implements IMessageHandler<PacketBooksellerChoice, IMessage> {
  public IMessage onMessage(PacketBooksellerChoice message, MessageContext ctx) {
    EntityPlayerMP player = (ctx.getServerHandler()).field_147369_b;
    VieilleHistoire.reward(player, PacketBooksellerChoice.access$000(message));
    return null;
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\network\may\PacketBooksellerChoice$Handler.class
