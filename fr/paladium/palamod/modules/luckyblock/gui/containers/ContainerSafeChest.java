...
public class ContainerSafeChest extends Container {
  ...
  private TileEntitySafeChest tile;
  
  public ContainerSafeChest(SimpleGHandler.GuiHandlerData data) {
    this((TileEntitySafeChest)data.getTileEntity(TileEntitySafeChest.class), data.getInventory());
  }
  
  public ContainerSafeChest(TileEntitySafeChest tile, InventoryPlayer inventory) {
    this.tile = tile;
    int i;
    for (i = 0; i < 6; i++) {
      for (int j = 0; j < 9; j++) {
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\gui\containers\ContainerSafeChest.class
