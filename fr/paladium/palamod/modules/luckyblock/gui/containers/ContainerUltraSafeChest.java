...
public class ContainerUltraSafeChest extends Container {
  private int numRows = 6;
  
  private TileEntityUltraSafeChest tile;
  
  public ContainerUltraSafeChest(TileEntityUltraSafeChest tile, InventoryPlayer inventory) {
    this.tile = tile;
    int i;
    for (i = 0; i < 6; i++) {
      for (int j = 0; j < 9; j++) {
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\gui\containers\ContainerUltraSafeChest.class
