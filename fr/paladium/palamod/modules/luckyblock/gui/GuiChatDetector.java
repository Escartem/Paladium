...
public class GuiChatDetector extends GuiContainer {
  ...
  private final TileEntityChatDetector te;
  
  private final FontRenderer fontRendererObj;
  
  public GuiChatDetector(TileEntityChatDetector te) {
  ...
  public void func_73866_w_() {
    ...
    this.usernameInput.func_146180_a(this.te.getWord());
  }
  ...
  protected void func_73869_a(char par1, int pressedKey) {
    if (pressedKey == 1 || (!this.usernameInput.func_146206_l() && pressedKey == this.field_146297_k.field_71474_y.field_151445_Q
      .func_151463_i())) {
      PacketChatDetector packet = new PacketChatDetector();
  ...
  protected void func_146976_a(float par1, int par2, int par3) {
    ...
    this.fontRendererObj.func_78261_a("Detecting: " + this.te.getWord(), x + this.field_146999_f / 2 - this.fontRendererObj
        .func_78256_a("Detecting: " + this.te.getWord()) / 2, y + 44, 16777215);
  }
  
  protected void func_146979_b(int param1, int param2) {
    this.fontRendererObj.func_78276_b("Chat detector", 8, 6, 4210752);
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\gui\GuiChatDetector.class
