...
public class Handler implements IMessageHandler<BBPacketShopLuckyStatsData, IMessage> {
  public IMessage onMessage(BBPacketShopLuckyStatsData message, MessageContext ctx) {
    if (ctx.side == Side.CLIENT) {
      ...
      if (ui != null)
        ui.getDataSignal().set(BBPacketShopLuckyStatsData.access$000(message)); 
    } else {
