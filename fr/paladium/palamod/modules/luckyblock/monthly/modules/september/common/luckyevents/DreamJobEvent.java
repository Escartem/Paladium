...
public class DreamJobEvent extends ALuckyEvent implements ISchematic {
  private static final String EVENT_NAME = "Le métier de rêve d'une génération";
  
  private static final boolean IS_BAD = false;
  
  private static final int RARITY = 250;
  
  private static final String TEXTURE_PATH = "september/dream_job";
  
  public static final String SCHEMATIC_NAME = "lb09_cockpit.schematic";
  
  public static final String MOON_SCHEMATIC_NAME = "lb09_lune.schematic";
  
  public static final String SOUND_NAME = "rocket";
  ...
  public String getName() {
    return "Le métier de rêve d'une génération";
  }
  ...
  public String getTexture() {
    return "september/dream_job";
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\september\common\luckyevents\DreamJobEvent.class
