...
public class TileEntityPrimaryTaupikoEgg extends TileEntity {
  public static final String TILE_ENTITY_ID = "tileEntityPrimaryTaupikoEgg";
  ...
  public void func_145845_h() {
    ...
    if (this.timeElapsed >= MAX_TIME_ELAPSED) {
      ...
      ItemUtils.spawnItemAtEntity((Entity)entityPlayerMP, new ItemStack(ItemsRegister.TAUPIKO_EGG));
      return;
    } 
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\september\common\tiles\TileEntityPrimaryTaupikoEgg.class
