...
public class BlockMonsterBlackHole extends Block implements ITileEntityProvider, ITooltipInformations {
  private static final String NAME = "monster_black_hole";
  
  private static String DESCRIPTION = "Une fois posé cet objet attire les monstres dans un rayon de 15 blocs.";
  
  public BlockMonsterBlackHole() {
    super(Material.field_151575_d);
    func_149663_c("monster_black_hole");
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    ...
    if (!(tile instanceof TileEntityMonsterBlackHole))
      return; 
    ItemStack stack = new ItemStack(BlocksRegister.MONSTER_BLACK_HOLE);
  ...
  public TileEntity func_149915_a(World world, int metadata) {
    return (TileEntity)new TileEntityMonsterBlackHole();
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\march\common\block\BlockMonsterBlackHole.class
