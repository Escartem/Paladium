...
public class EntityJupiterGravitySplashPotion extends EntityThrowable {
  public static final String ENTITY_ID = "entityJupiterGravitySplashPotion";
  
  public EntityJupiterGravitySplashPotion(World world) {
    super(world);
  }
  
  public EntityJupiterGravitySplashPotion(World world, EntityPlayer player) {
  ...
  public void applyPotionEffect(MovingObjectPosition p_70184_1_) {
    ...
    if (list1 != null && !list1.isEmpty()) {
      ...
      while (iterator.hasNext()) {
        ...
        if (d0 < 16.0D)
          entitylivingbase.func_70690_d(new PotionEffect(PotionsRegister.JUPITER_GRAVITY
                .getPotionId(), 
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\march\common\entity\potions\EntityJupiterGravitySplashPotion.class
