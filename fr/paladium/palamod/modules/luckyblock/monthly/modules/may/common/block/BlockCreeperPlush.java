...
public class BlockCreeperPlush extends Block implements ITileEntityProvider {
  private static final String NAME = "creeper_plush";
  
  public BlockCreeperPlush() {
    super(Material.field_151575_d);
    func_149663_c("creeper_plush");
    func_149658_d("palamod:creeper_plush");
  ...
  public boolean func_149727_a(World world, int x, int y, int z, EntityPlayer player, int side, float hitX, float hitY, float hitZ) {
    ...
    if (!(tile instanceof TileEntityCreeperPlush))
      return true; 
    return true;
  }
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    ...
    if (!(tile instanceof TileEntityCreeperPlush))
      return; 
    ItemStack stack = new ItemStack(BlocksRegister.CREEPER_PLUSH);
  ...
  public TileEntity func_149915_a(World world, int metadata) {
    return (TileEntity)new TileEntityCreeperPlush();
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\may\common\block\BlockCreeperPlush.class
