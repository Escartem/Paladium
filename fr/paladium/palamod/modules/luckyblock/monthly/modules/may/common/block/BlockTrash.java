...
public class BlockTrash extends Block implements ITileEntityProvider, ITooltipInformations {
  private static final String NAME = "trash";
  
  public BlockTrash() {
    super(Material.field_151573_f);
    func_149663_c("trash");
    func_149658_d("palamod:trash");
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    ...
    if (!(tile instanceof TileEntityTrash))
      return; 
    ItemStack stack = new ItemStack(BlocksRegister.TRASH);
  ...
  public TileEntity func_149915_a(World world, int metadata) {
    return (TileEntity)new TileEntityTrash();
  }
  ...
  public int func_149645_b() {
    return ClientProxy.renderTrash;
  }
  
  public String[] getInformations(ItemStack arg0, EntityPlayer arg1, boolean arg2) {
    return MonthlyUtils.splitDescription("Permet de faire disparaître les objets qui entre en contact avec elle.");
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\may\common\block\BlockTrash.class
