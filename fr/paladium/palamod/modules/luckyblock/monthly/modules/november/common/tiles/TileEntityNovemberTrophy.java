...
public class TileEntityNovemberTrophy extends TileEntity implements IEntityAdditionalSpawnData {
  public static final String TILE_ENTITY_ID = "tileEntityNovemberTrophy";
  ...
  public TileEntityNovemberTrophy() {
    this.owner = null;
    this.ownerName = null;
  }
  
  public TileEntityNovemberTrophy(String owner) {
    this.owner = owner;
  }
