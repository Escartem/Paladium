...
public class ItemCorruptedTicket extends Item implements ITooltipInformations {
  public static final String NAME = "corrupted_ticket";
  
  public static final String NBT_OWNER_FIELD = "owner";
  
  public static final String NBT_COOLDOWN_FIELD = "cooldown";
  
  public static final String TELEPORTATION_MESSAGE = "§eVous avez été téléporté à LOCATION:PALANIMALERIE !";
  ...
  public static final String DESCRIPTION = "RIGHTCLIC.ACTION en HOLDING sur le EVENT.SERVER pour être ACTION:TELEPORT à la LOCATION:PALANIMALERIE !";
  
  public static final String SERVER_NAME = "EVENT";
  
  public static final long COOLDOWN_DURATION_MILLIS = TimeUnit.HOURS.toMillis(2L);
  
  public ItemCorruptedTicket() {
    func_77655_b("corrupted_ticket");
    func_111206_d("palamod:corrupted_ticket");
  ...
  private boolean isOnCorrectServer(EntityPlayer player) {
    ...
    if (serverName == null || !serverName.equalsIgnoreCase("EVENT")) {
      MonthlyUtils.sendMessage(player, new String[] { "RIGHTCLIC.ACTION en HOLDING sur le EVENT.SERVER pour être ACTION:TELEPORT à la LOCATION:PALANIMALERIE !" });
      return false;
    } 
    return true;
  }
  ...
  private void teleport(EntityPlayer player) {
    ...
    if (location == null)
      return; 
    MonthlyUtils.sendMessage(player, new String[] { "§eVous avez été téléporté à LOCATION:PALANIMALERIE !" });
  ...
  public String[] getInformations(ItemStack itemStack, EntityPlayer entityPlayer, boolean b) {
    return MonthlyUtils.splitDescription("RIGHTCLIC.ACTION en HOLDING sur le EVENT.SERVER pour être ACTION:TELEPORT à la LOCATION:PALANIMALERIE !");
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\november\common\items\ItemCorruptedTicket.class
