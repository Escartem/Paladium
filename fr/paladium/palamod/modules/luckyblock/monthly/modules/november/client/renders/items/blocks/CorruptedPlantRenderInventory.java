...
public class CorruptedPlantRenderInventory implements ISimpleBlockRenderingHandler {
  public void renderInventoryBlock(Block block, int meta, int modelId, RenderBlocks renderer) {
    if (block == BlocksRegister.CORRUPTED_PLANT) {
      GL11.glPushMatrix();
      GL11.glRotatef(180.0F, 0.0F, 0.0F, 1.0F);
      GL11.glRotatef(180.0F, 0.0F, 1.0F, 0.0F);
      GL11.glTranslatef(0.0F, -1.0F, 0.0F);
      Minecraft.func_71410_x().func_110434_K().func_110577_a(TileEntityCorruptedPlantRenderer.getTexture());
      IModelPlant model = (IModelPlant)TileEntityCorruptedPlantRenderer.MODELS[4];
      model.renderAll();
      GL11.glPopMatrix();
    } 
  }
