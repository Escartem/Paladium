package fr.paladium.palamod.modules.luckyblock.monthly.modules.november.client.gui;

import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;
import fr.paladium.palamod.modules.luckyblock.monthly.modules.november.common.containers.ContainerCorruptedEnchantment;
...
public class GuiCorruptedEnchantment extends GuiContainer {
  private static final ResourceLocation field_147078_C = new ResourceLocation("palamod", "textures/gui/corrupted_enchanting_table.png");
  ...
  private final ContainerCorruptedEnchantment field_147075_G;
  ...
  public GuiCorruptedEnchantment(InventoryPlayer p_i1090_1_, World p_i1090_2_, int p_i1090_3_, int p_i1090_4_, int p_i1090_5_) {
    super((Container)new ContainerCorruptedEnchantment(p_i1090_1_, p_i1090_2_, p_i1090_3_, p_i1090_4_, p_i1090_5_));
    this.field_147075_G = (ContainerCorruptedEnchantment)this.field_147002_h;
    this.field_147079_H = null;
  }
  ...
  protected void func_73864_a(int p_73864_1_, int p_73864_2_, int p_73864_3_) {
    ...
    for (int j1 = 0; j1 < 3; j1++) {
      ...
      if (k1 >= 0 && l1 >= 0 && k1 < 108 && l1 < 19 && this.field_147075_G.func_75140_a((EntityPlayer)this.field_146297_k.field_71439_g, j1))
  ...
  protected void func_146976_a(float p_146976_1_, int p_146976_2_, int p_146976_3_) {
    ...
    f5 = (f5 - MathHelper.func_76140_b(f5)) * 1.6F - 0.3F;
    if (f4 < 0.0F)
      f4 = 0.0F; 
    if (f5 < 0.0F)
      f5 = 0.0F; 
    ...
    for (int i1 = 0; i1 < 3; i1++) {
      ...
      GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
      if (j1 == 0) {
        func_73729_b(k + 60, l + 14 + 19 * i1, 0, 185, 108, 19);
      } else {
        String s1 = "" + j1;
        ...
        if (this.field_146297_k.field_71439_g.field_71068_ca < j1 && !this.field_146297_k.field_71439_g.field_71075_bZ.field_75098_d) {
          func_73729_b(k + 60, l + 14 + 19 * i1, 0, 185, 108, 19);
          fontrenderer.func_78279_b(s, k + 62, l + 16 + 19 * i1, 104, (k1 & 0xFEFEFE) >> 1);
          ...
          if (l1 >= 0 && i2 >= 0 && l1 < 108 && i2 < 19) {
            func_73729_b(k + 60, l + 14 + 19 * i1, 0, 204, 108, 19);
            k1 = 16777088;
          } else {
            func_73729_b(k + 60, l + 14 + 19 * i1, 0, 166, 108, 19);
          } 
