...
import fr.paladium.palamod.modules.luckyblock.monthly.modules.november.client.models.blocks.ModelNovemberTrophy;
...
public class TileEntityNovemberTrophyRenderer extends TileEntitySpecialRenderer {
  private static final String TROPHY_TEXT = "§eTrophée de§7: §d";
  
  public static ModelNovemberTrophy getModel() {
    return model;
  }
  
  private static ModelNovemberTrophy model = new ModelNovemberTrophy();
  
  public static ResourceLocation getTexture() {
    return texture;
  }
  
  private static ResourceLocation texture = new ResourceLocation("palamod", "textures/blocks/trophy/november/november_trophy.png");
  
  public void func_147500_a(TileEntity te, double x, double y, double z, float ticks) {
    renderText((TileEntityNovemberTrophy)te, x, y, z, ticks);
    renderBlockTileEntityAt((TileEntityNovemberTrophy)te, x, y, z, ticks);
  }
  
  private void renderText(TileEntityNovemberTrophy tile, double x, double y, double z, float ticks) {
  ...
  private void renderBlockTileEntityAt(TileEntityNovemberTrophy tile, double x, double y, double z, float ticks) {
    float scale = 1.1F;
    GL11.glPushMatrix();
