...
public class TileEntityPrimarySlayerEgg extends TileEntity {
  public static final String TILE_ENTITY_ID = "tileEntityPrimarySlayerEgg";
  ...
  private static final int POTION_EFFECT_DURATION = 10;
  ...
  public void func_145845_h() {
    super.func_145845_h();
    if (this.field_145850_b.field_72995_K || this.ownerId == null)
      return; 
    this.tick++;
    if (this.tick % 20 != 0)
      return; 
    ...
    if (this.timeElapsed >= MAX_TIME_ELAPSED) {
      ...
      ItemUtils.spawnItemAtEntity((Entity)entityPlayerMP, new ItemStack(ItemsRegister.SLAYER_EGG));
      return;
    } 
    if (!isOwnerUpperTile((EntityPlayer)entityPlayerMP))
      return; 
    entityPlayerMP.func_70690_d(new PotionEffect(Potion.field_82731_v.field_76415_H, 
          
          MonthlyUtils.translateSecondsToTicks(10), 0));
    this.timeElapsed++;
  }
