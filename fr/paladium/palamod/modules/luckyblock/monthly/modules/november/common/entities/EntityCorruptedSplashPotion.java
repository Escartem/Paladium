...
public class EntityCorruptedSplashPotion extends EntityThrowable {
  public static final Interval CORRUPTION_INTERVAL = new Interval(10, 20);
  
  public static final String ENTITY_ID = "entityCorruptedSplashPotion";
  
  public EntityCorruptedSplashPotion(World world) {
    super(world);
  }
  
  public EntityCorruptedSplashPotion(World world, EntityPlayer player) {
  ...
  public void applyPotionEffect(MovingObjectPosition p_70184_1_) {
    ...
    if (list1 != null && !list1.isEmpty()) {
      ...
      while (iterator.hasNext()) {
        ...
        if (d0 < 16.0D) {
          int duration = CORRUPTION_INTERVAL.getRandom();
          entitylivingbase.func_70690_d(new PotionEffect(Potion.field_82731_v.field_76415_H, 
                
                MonthlyUtils.translateSecondsToTicks(duration), 1));
        } 
      } 
    } 
