...
public class BlockNovemberTrophy extends BlockTrophyBase {
  public BlockNovemberTrophy() {
    func_149663_c("november_trophy");
    func_149658_d("palamod:trophy/november/november_trophy");
  }
  ...
  public TileEntity createTileEntity(World world, int metadata) {
    return (TileEntity)new TileEntityNovemberTrophy();
  }
  ...
  public void func_149689_a(World world, int x, int y, int z, EntityLivingBase player, ItemStack item) {
    ...
    TileEntityNovemberTrophy tile = (TileEntityNovemberTrophy)world.func_147438_o(x, y, z);
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    if (!world.field_72995_K && EventUtils.canInteract(player, x, y, z)) {
      TileEntityNovemberTrophy te = (TileEntityNovemberTrophy)world.func_147438_o(x, y, z);
      if (te != null) {
  ...
  public int func_149645_b() {
    return ClientProxy.renderNovemberTrophy;
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\november\common\blocks\BlockNovemberTrophy.class
