...
public class BlockAugustTrophy extends BlockTrophyBase {
  public BlockAugustTrophy() {
    func_149663_c("august_trophy");
    func_149658_d("palamod:trophy/august/august_trophy");
  }
  ...
  public TileEntity createTileEntity(World world, int metadata) {
    return (TileEntity)new TileEntityAugustTrophy();
  }
  ...
  public void func_149689_a(World world, int x, int y, int z, EntityLivingBase player, ItemStack item) {
    ...
    TileEntityAugustTrophy tile = (TileEntityAugustTrophy)world.func_147438_o(x, y, z);
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    if (!world.field_72995_K && EventUtils.canInteract(player, x, y, z)) {
      TileEntityAugustTrophy te = (TileEntityAugustTrophy)world.func_147438_o(x, y, z);
      if (te != null) {
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\august\common\blocks\BlockAugustTrophy.class
