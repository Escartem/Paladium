...
class null extends Slot {
  ...
  public void func_82870_a(EntityPlayer player, ItemStack item) {
    ...
    if (FMLCommonHandler.instance().getEffectiveSide().isServer()) {
      CobbleBreakerObjective.performCheck(player, (ContainerCrabCobbleBreaker.access$000(ContainerCrabCobbleBreaker.this) == null) ? item : ContainerCrabCobbleBreaker.access$000(ContainerCrabCobbleBreaker.this));
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\august\common\containers\ContainerCrabCobbleBreaker$3.class
