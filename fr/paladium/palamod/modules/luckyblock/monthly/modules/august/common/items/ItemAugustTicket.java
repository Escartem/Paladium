...
public class ItemAugustTicket extends Item implements ITooltipInformations {
  public static final String NAME = "august_ticket";
  
  public static final String NBT_OWNER_FIELD = "owner";
  
  public static final String NBT_COOLDOWN_FIELD = "cooldown";
  
  public static final String TELEPORTATION_MESSAGE = "§eVous avez été téléporté à la Palanimalerie";
  ...
  public static final String OWN_ANIMAL_MESSAGE = "&cVous êtes déjà en possession d'un crabe !";
  ...
  public ItemAugustTicket() {
    func_77655_b("august_ticket");
    func_111206_d("palamod:august_ticket");
  ...
  private boolean hasAnimal(EntityPlayer player) {
    PlayerLuckyBlockProperties properties = PlayerLuckyBlockProperties.get(player);
    if (properties == null)
      return true; 
    if (properties.isOwnCrab()) {
      MonthlyUtils.sendMessage(player, new String[] { "&cVous êtes déjà en possession d'un crabe !" });
      return true;
    } 
    return false;
  }
  ...
  private void teleport(EntityPlayer player) {
    ...
    if (location == null)
      return; 
    MonthlyUtils.sendMessage(player, new String[] { "§eVous avez été téléporté à la Palanimalerie" });
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\august\common\items\ItemAugustTicket.class
