...
public class TreasureChestManager {
  ...
  private JulyConfigManager configManager;
  
  private ItemStack[] rewards;
  
  public TreasureChestManager() {
    instance = this;
    this.configManager = JulyConfigManager.getInstance();
  ...
  public boolean openChest(EntityPlayerMP player, DoubleLocation location) {
    ...
    properties.setPirateChestOpened(true);
  ...
  public boolean hasAlreadyOpenedTreasureChest(PlayerLuckyBlockProperties properties) {
    return properties.isPirateChestOpened();
  }
  ...
  public DoubleLocation getTreasureChestLocation() {
    return this.configManager.getConfig().getPirateChestLocation();
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\july\common\managers\TreasureChestManager.class
