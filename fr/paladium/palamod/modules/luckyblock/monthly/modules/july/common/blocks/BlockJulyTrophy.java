...
public class BlockJulyTrophy extends BlockTrophyBase {
  public BlockJulyTrophy() {
    func_149663_c("july_trophy");
    func_149658_d("palamod:trophy/july/july_trophy");
  }
  ...
  public TileEntity createTileEntity(World world, int metadata) {
    return (TileEntity)new TileEntityJulyTrophy();
  }
  ...
  public void func_149689_a(World world, int x, int y, int z, EntityLivingBase player, ItemStack item) {
    ...
    TileEntityJulyTrophy tile = (TileEntityJulyTrophy)world.func_147438_o(x, y, z);
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    if (!world.field_72995_K && EventUtils.canInteract(player, x, y, z)) {
      TileEntityJulyTrophy te = (TileEntityJulyTrophy)world.func_147438_o(x, y, z);
      if (te != null) {
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\july\common\blocks\BlockJulyTrophy.class
