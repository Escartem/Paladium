...
public class NoPowderTalkEvent extends ALuckyEvent {
  ...
  private static final String TEXTURE_PATH = "july/powder_talk_no";
  ...
  private void giveItems(World world, int x, int y, int z) {
    ItemUtils.spawnItemInWorld(world, x, y, z, new ItemStack(BlocksRegister.BARREL_WOOD, 64));
    ItemUtils.spawnItemInWorld(world, x, y, z, new ItemStack(BlocksRegister.BARREL_WOOD, 36));
  }
  ...
  public String getTexture() {
    return "july/powder_talk_no";
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\luckyblock\monthly\modules\july\common\luckyevents\NoPowderTalkEvent.class
