...
public class CSEnchantItem implements IMessage {
  public int index;
  
  public CSEnchantItem() {}
  
  public CSEnchantItem(int index) {
    this.index = index;
  }
  ...
  public static class Handler implements IMessageHandler<CSEnchantItem, IMessage> {
