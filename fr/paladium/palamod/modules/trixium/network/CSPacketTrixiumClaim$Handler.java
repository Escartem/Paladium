...
public class Handler implements IMessageHandler<CSPacketTrixiumClaim, IMessage> {
  @SideOnly(Side.SERVER)
  public IMessage onMessage(CSPacketTrixiumClaim message, MessageContext ctx) {
    TrixiumAPI.getExecutor().submit(() -> {
          TrixiumRewardConfig reward = TrixiumManager.getReward(CSPacketTrixiumClaim.access$000(message));
          if (reward == null)
            return; 
          try {
