...
public class Handler implements IMessageHandler<CSPacketTrixiumRankingPlayerPage, IMessage> {
  public IMessage onMessage(CSPacketTrixiumRankingPlayerPage message, MessageContext ctx) {
    TrixiumAPI.getExecutor().submit(() -> {
          try {
            PlayerTrixiumRanking ranking = new PlayerTrixiumRanking(20, CSPacketTrixiumRankingPlayerPage.access$000(message));
            ...
            PTrixium.getNetwork().sendTo(new SCPacketTrixiumRankingPlayerPage(CSPacketTrixiumRankingPlayerPage.access$000(message), (List<TrixiumProfile>)response.body()), (ctx.getServerHandler()).field_147369_b);
          } catch (Exception e) {
            e.printStackTrace();
            (new Notification(Notification.NotificationType.ERROR, "Impossible de charger le classement joueur", "trixium")).send((ctx.getServerHandler()).field_147369_b);
          } 
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\trixium\network\ranking\page\CSPacketTrixiumRankingPlayerPage$Handler.class
