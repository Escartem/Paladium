package fr.paladium.palamod.modules.hunter.entites.ai;
...
public class EntitySnakeAIAttack extends EntityAIBase {
  World worldObj;
  ...
  public EntitySnakeAIAttack(EntityCreature p_i1635_1_, Class p_i1635_2_, double p_i1635_3_, boolean p_i1635_5_) {
    this(p_i1635_1_, p_i1635_3_, p_i1635_5_);
    this.classTarget = p_i1635_2_;
  }
  
  public EntitySnakeAIAttack(EntityCreature p_i1636_1_, double p_i1636_2_, boolean p_i1636_4_) {
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\hunter\entites\ai\EntitySnakeAIAttack.class
