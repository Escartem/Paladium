...
public class EntityFarmerChicken extends EntityChicken {
  public EntityFarmerChicken(World world) {
    super(world);
    this.field_70714_bg.func_75776_a(8, (EntityAIBase)new EntityAIAvoidEntity((EntityCreature)this, EntityPlayer.class, 10.0F, 2.0D, 1.7D));
  }
  ...
  public void func_70645_a(DamageSource damageSource) {
    ...
    if (damageSource.func_76346_g() instanceof EntityPlayer) {
      ...
      UseItemAchievement.performCheck(player, player.func_71045_bC(), "MINI_BOSS_KILL_FARMER_CHICKEN");
      JobsPlayer jobPlayer = JobsPlayer.get((Entity)player);
      if (jobPlayer != null) {
        int xp = JobExpUtils.getNeededXpForLvl(jobPlayer.getLevel(JobType.FARMER) + 1) / 10;
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\hunter\entites\EntityFarmerChicken.class
