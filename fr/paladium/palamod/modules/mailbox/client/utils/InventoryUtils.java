package fr.paladium.palamod.modules.mailbox.client.utils;
  ...
  public static int getItemCount(EntityPlayer player, ItemStack item) {
    ...
    for (int i = 0; i < j; i++) {
      ...
      if (!isNullItem(current) && current.func_77973_b() == item.func_77973_b() && 
        ItemStack.func_77970_a(current, item))
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\mailbox\clien\\utils\InventoryUtils.class
