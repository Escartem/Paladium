...
public class Handler implements IMessageHandler<MailboxServerProcessMailPacket, IMessage> {
  public IMessage onMessage(MailboxServerProcessMailPacket message, MessageContext ctx) {
    PaladiumScheduler.INSTANCE.runTaskAsyncLater(() -> {
          try {
            String mailId = MailboxServerProcessMailPacket.access$000(message);
            ...
            switch (MailboxServerProcessMailPacket.null.$SwitchMap$fr$paladium$palamod$modules$mailbox$common$packets$server$EnumMailActions[MailboxServerProcessMailPacket.access$100(message).ordinal()]) {
              case 1:
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\mailbox\common\packets\server\MailboxServerProcessMailPacket$Handler.class
