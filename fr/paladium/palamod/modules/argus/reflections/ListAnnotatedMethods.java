...
public class ListAnnotatedMethods {
  ...
  public static MyHashSet<String> nh(Reflections rf, MyHashSet<String> a) {
    Arrays.<Class<? extends Annotation>>asList(MethodsRef._a).forEach(q -> a.p((Collection)getMethodsAnnotatedWith(rf, q).stream().map(()).collect(Collectors.toList())));
    return a;
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\argus\reflections\ListAnnotatedMethods.class
