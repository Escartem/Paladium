...
public class ModelEndermite extends ModelBase {
  ...
  public ModelEndermite() {
    ...
    for (int i = 0; i < this.field_178713_d.length; i++) {
      ...
      this.field_178713_d[i].func_78789_a(field_178716_a[i][0] * -0.5F, 0.0F, field_178716_a[i][2] * -0.5F, field_178716_a[i][0], field_178716_a[i][1], field_178716_a[i][2]);
      this.field_178713_d[i].func_78793_a(0.0F, (24 - field_178716_a[i][1]), f);
  ...
  public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_) {
    for (int i = 0; i < this.field_178713_d.length; i++) {
      (this.field_178713_d[i])
        ...
        .field_78796_g = MathHelper.func_76134_b(p_78087_3_ * 0.9F + i * 0.15F * 3.1415927F) * 3.1415927F * 0.01F * (1 + Math.abs(i - 2));
      (this.field_178713_d[i])
        
        .field_78800_c = MathHelper.func_76126_a(p_78087_3_ * 0.9F + i * 0.15F * 3.1415927F) * 3.1415927F * 0.1F * Math.abs(i - 2);
    } 
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\back2future\client\model\ModelEndermite.class
