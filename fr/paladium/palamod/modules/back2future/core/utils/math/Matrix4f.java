...
public final class Matrix4f {
  ...
  public void multiply(Quaternion p_226596_1_) {
    multiply(new Matrix4f(p_226596_1_));
  }
  ...
  public Matrix4f(float[] p_i244839_1_) {
    this.m00 = p_i244839_1_[0];
    this.m01 = p_i244839_1_[1];
    this.m02 = p_i244839_1_[2];
    this.m03 = p_i244839_1_[3];
    this.m10 = p_i244839_1_[4];
    this.m11 = p_i244839_1_[5];
    this.m12 = p_i244839_1_[6];
    this.m13 = p_i244839_1_[7];
    this.m20 = p_i244839_1_[8];
    this.m21 = p_i244839_1_[9];
    this.m22 = p_i244839_1_[10];
    this.m23 = p_i244839_1_[11];
    this.m30 = p_i244839_1_[12];
    this.m31 = p_i244839_1_[13];
    this.m32 = p_i244839_1_[14];
    this.m33 = p_i244839_1_[15];
  }
  ...
  public void multiplyBackward(Matrix4f p_multiplyBackward_1_) {
    Matrix4f copy = p_multiplyBackward_1_.copy();
    copy.multiply(this);
    set(copy);
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\back2future\cor\\utils\math\Matrix4f.class
