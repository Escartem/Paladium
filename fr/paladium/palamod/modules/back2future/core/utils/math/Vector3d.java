...
public class Vector3d implements IPosition {
  ...
  public static Vector3d fromRGB24(int p_237487_0_) {
    double d0 = (p_237487_0_ >> 16 & 0xFF) / 255.0D;
    double d1 = (p_237487_0_ >> 8 & 0xFF) / 255.0D;
    double d2 = (p_237487_0_ & 0xFF) / 255.0D;
    return new Vector3d(d0, d1, d2);
  }
  
  public static Vector3d atCenterOf(Vector3i p_237489_0_) {
    return new Vector3d(p_237489_0_.getX() + 0.5D, p_237489_0_.getY() + 0.5D, p_237489_0_
        .getZ() + 0.5D);
  }
  ...
  public static Vector3d atBottomCenterOf(Vector3i p_237492_0_) {
    return new Vector3d(p_237492_0_.getX() + 0.5D, p_237492_0_.getY(), p_237492_0_.getZ() + 0.5D);
  }
  
  public static Vector3d upFromBottomCenterOf(Vector3i p_237490_0_, double p_237490_1_) {
    return new Vector3d(p_237490_0_.getX() + 0.5D, p_237490_0_.getY() + p_237490_1_, p_237490_0_
        .getZ() + 0.5D);
  }
  ...
  public Vector3d normalize() {
    double d0 = MathHelper.func_76133_a(this.x * this.x + this.y * this.y + this.z * this.z);
  ...
  public Vector3d subtract(double p_178786_1_, double p_178786_3_, double p_178786_5_) {
    return add(-p_178786_1_, -p_178786_3_, -p_178786_5_);
  }
  
  public Vector3d add(Vector3d p_178787_1_) {
    return add(p_178787_1_.x, p_178787_1_.y, p_178787_1_.z);
  }
  ...
  public boolean closerThan(IPosition p_237488_1_, double p_237488_2_) {
    return (distanceToSqr(p_237488_1_.func_82615_a(), p_237488_1_.func_82617_b(), p_237488_1_.func_82616_c()) < p_237488_2_ * p_237488_2_);
  }
  ...
  public Vector3d scale(double p_186678_1_) {
    return multiply(p_186678_1_, p_186678_1_, p_186678_1_);
  }
  ...
  public Vector3d multiply(Vector3d p_216369_1_) {
    return multiply(p_216369_1_.x, p_216369_1_.y, p_216369_1_.z);
  }
  ...
  public Vector3d zRot(float p_242988_1_) {
    float f = MathHelper.func_76134_b(p_242988_1_);
    float f1 = MathHelper.func_76126_a(p_242988_1_);
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\back2future\cor\\utils\math\Vector3d.class
