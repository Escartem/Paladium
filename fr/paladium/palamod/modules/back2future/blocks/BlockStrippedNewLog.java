...
public class BlockStrippedNewLog extends BlockNewLog implements IConfigurable, ModBlocks.ISubBlocksBlock {
  ...
  public void func_149651_a(IIconRegister p_149651_1_) {
    this.field_150167_a = new net.minecraft.util.IIcon[field_150169_M.length];
    this.field_150166_b = new net.minecraft.util.IIcon[field_150169_M.length];
    for (int i = 0; i < this.field_150167_a.length; i++) {
      this.field_150167_a[i] = p_149651_1_.func_94245_a("stripped_" + field_150169_M[i] + "_log");
      this.field_150166_b[i] = p_149651_1_
        .func_94245_a("stripped_" + field_150169_M[i] + "_log_top");
    } 
  }
  ...
  public static void onPlayerInteract(PlayerInteractEvent event) {
    if (event.entityPlayer != null) {
      ...
      if (event.action == PlayerInteractEvent.Action.RIGHT_CLICK_BLOCK && 
        world.func_147439_a(event.x, event.y, event.z) == Blocks.field_150363_s) {
        ...
        if (stack != null && stack.func_77973_b() instanceof net.minecraft.item.ItemAxe) {
          world.func_147465_d(event.x, event.y, event.z, ModBlocks.log2_stripped, logMeta, 2);
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\back2future\blocks\BlockStrippedNewLog.class
