...
public enum EnumDyeColor {
  ...
  EnumDyeColor(int meta, int dyeDamage, String name, String unlocalizedName) {
    this.meta = meta;
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\back2future\lib\EnumDyeColor.class
