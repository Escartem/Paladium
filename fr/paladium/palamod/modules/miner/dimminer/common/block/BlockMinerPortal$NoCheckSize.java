...
public class NoCheckSize {
  ...
  protected int func_150853_a(int p_150853_1_, int p_150853_2_, int p_150853_3_, int p_150853_4_) {
    ...
    for (i1 = 0; i1 < 22; i1++) {
      ...
      if (!(tileEntity instanceof fr.paladium.palamod.modules.miner.dimminer.common.block.tileentity.TileEntityWitheredObsidian))
        break; 
    } 
    TileEntity te = this.world.func_147438_o(p_150853_1_ + j1 * i1, p_150853_2_, p_150853_3_ + k1 * i1);
    return (te instanceof fr.paladium.palamod.modules.miner.dimminer.common.block.tileentity.TileEntityWitheredObsidian) ? i1 : 0;
  }
    ...
    label40: for (this.field_150862_g = 0; this.field_150862_g < 21; this.field_150862_g++) {
      ...
      for (int j = 0; j < this.field_150868_h; j++) {
        ...
        if (j == 0) {
          ...
          if (!(te instanceof fr.paladium.palamod.modules.miner.dimminer.common.block.tileentity.TileEntityWitheredObsidian))
            break label40; 
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\miner\dimminer\common\block\BlockMinerPortal$NoCheckSize.class
