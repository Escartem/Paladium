...
public class EntityMinerBossStrikingGroundAttack implements IEntityMinerBossAttack {
  ...
  public void update(EntityMinerBoss entity, EntityLivingBase target) {
    ...
    if (this.tick >= getDuration()) {
      ...
      entity.setStunted(true);
      entity.setStuntedDelay(80);
      this.finished = true;
    } 
    this.tick++;
  }
  ...
  public int getChance(EntityMinerBoss entity) {
    ...
    return (state == 0) ? 25 : ((state == 1) ? 20 : ((state == 2) ? 15 : ((state == 3) ? 25 : ((state == 4) ? 20 : ((state == 5) ? 15 : 0)))));
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\miner\dimminer\common\entity\attack\EntityMinerBossStrikingGroundAttack.class
