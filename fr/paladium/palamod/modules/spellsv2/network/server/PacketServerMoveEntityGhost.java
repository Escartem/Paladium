...
public class PacketServerMoveEntityGhost implements IMessage {
  public double x;
  ...
  public PacketServerMoveEntityGhost() {}
  
  public PacketServerMoveEntityGhost(double x, double y, double z) {
    this.x = x;
    this.y = y;
    this.z = z;
  }
  ...
  public static class Handler implements IMessageHandler<PacketServerMoveEntityGhost, IMessage> {
