...
public class PacketServerUseSpell implements IMessage {
  public int spell;
  
  public int tier;
  
  public PacketServerUseSpell() {}
  
  public PacketServerUseSpell(int spell, int tier) {
    this.spell = spell;
    this.tier = tier;
  }
  ...
  public static class Handler implements IMessageHandler<PacketServerUseSpell, IMessage> {
