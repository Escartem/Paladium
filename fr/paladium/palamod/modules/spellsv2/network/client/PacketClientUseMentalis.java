...
public class PacketClientUseMentalis implements IMessage {
  public boolean active;
  
  public String uuid;
  
  public PacketClientUseMentalis() {}
  
  public PacketClientUseMentalis(boolean active, String uuid) {
    this.active = active;
    this.uuid = uuid;
  }
  ...
  public static class Handler implements IMessageHandler<PacketClientUseMentalis, IMessage> {
