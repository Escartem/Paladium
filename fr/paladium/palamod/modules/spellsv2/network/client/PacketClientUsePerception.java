...
public class PacketClientUsePerception implements IMessage {
  public int tier;
  
  public PacketClientUsePerception() {}
  
  public PacketClientUsePerception(int tier) {
    this.tier = tier;
  }
  ...
  public static class Handler implements IMessageHandler<PacketClientUsePerception, IMessage> {
