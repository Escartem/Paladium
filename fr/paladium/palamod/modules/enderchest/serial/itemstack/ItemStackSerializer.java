  ...
  public static ItemStack read(String in) {
    ...
    try {
      ...
      try {
        ...
        System.err.println("Could not read NBT data from " + data + ":" + e.toString());
      } 
      return stack;
    } catch (Exception e) {
      System.err.println("Unable to make ItemStack for " + data + ":" + e.toString());
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\enderchest\serial\itemstack\ItemStackSerializer.class
