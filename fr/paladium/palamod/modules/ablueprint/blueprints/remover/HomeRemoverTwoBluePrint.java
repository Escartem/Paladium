...
public class HomeRemoverTwoBluePrint extends ABluePrint {
  public static final String ID = "home_remover_two";
  
  public HomeRemoverTwoBluePrint() {
    super("home_remover_two");
  }
  
  protected void init() {
    addFloors(new Floor[] { Floor.create().addPatterns(new String[] { "QQQQQ", "QQQQQ", "QQQQQ", "QQQQQ", "QQQQQ" }), Floor.create().addPatterns(new String[] { "     ", " QQQ ", " QQQ ", " QQQ ", "     " }), Floor.create().addPatterns(new String[] { "     ", "     ", "  H  ", "     ", "     " }) });
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\ablueprint\blueprints\remover\HomeRemoverTwoBluePrint.class
