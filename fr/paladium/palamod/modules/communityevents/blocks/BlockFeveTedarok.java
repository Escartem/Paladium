...
public class BlockFeveTedarok extends Block {
  public BlockFeveTedarok() {
    super(Material.field_151576_e);
    func_149663_c("feve_tedarok");
    func_149658_d("palamod:feve_tedarok");
    func_149647_a(PLuckyBlock.TAB);
    func_149711_c(1.0F);
    func_149676_a(0.3F, 0.0F, 0.0F, 0.7F, 0.6F, 1.0F);
  }
  ...
  public TileEntity createTileEntity(World world, int metadata) {
    return (TileEntity)new TileEntityFeveTedarok();
  }
  ...
  public void func_149719_a(IBlockAccess iblockaccess, int x, int y, int z) {
    ...
    if (metadata % 2 == 0) {
      ...
      func_149676_a(0.0F, 0.0F, 0.3F, 1.0F, 0.6F, 0.7F);
    } 
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\communityevents\blocks\BlockFeveTedarok.class
