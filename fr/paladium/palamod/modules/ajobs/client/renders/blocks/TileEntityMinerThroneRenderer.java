...
public class TileEntityMinerThroneRenderer extends TileEntitySpecialRenderer {
  ...
  private static ResourceLocation texture = new ResourceLocation("palamod", "textures/blocks/thrones/miner.png");
  ...
  public void func_147500_a(TileEntity te, double x, double y, double z, float ticks) {
    renderBlockTileEntityAt((TileEntityMinerThrone)te, x, y, z, ticks);
  }
  
  private void renderBlockTileEntityAt(TileEntityMinerThrone tile, double x, double y, double z, float ticks) {
    GL11.glPushMatrix();
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\ajobs\client\renders\blocks\TileEntityMinerThroneRenderer.class
