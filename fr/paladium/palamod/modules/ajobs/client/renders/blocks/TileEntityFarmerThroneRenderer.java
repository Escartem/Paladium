...
public class TileEntityFarmerThroneRenderer extends TileEntitySpecialRenderer {
  ...
  private static ResourceLocation texture = new ResourceLocation("palamod", "textures/blocks/thrones/farmer.png");
  
  public void func_147500_a(TileEntity te, double x, double y, double z, float ticks) {
    renderBlockTileEntityAt((TileEntityFarmerThrone)te, x, y, z, ticks);
  }
  
  private void renderBlockTileEntityAt(TileEntityFarmerThrone tile, double x, double y, double z, float ticks) {
    GL11.glPushMatrix();
...
/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\ajobs\client\renders\blocks\TileEntityFarmerThroneRenderer.class
