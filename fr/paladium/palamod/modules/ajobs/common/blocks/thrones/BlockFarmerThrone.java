...
public class BlockFarmerThrone extends BlockThroneBase {
  public BlockFarmerThrone() {
    func_149663_c("farmer_throne");
    func_149676_a(0.0F, 0.5F, 0.0F, 1.0F, 2.0F, 1.0F);
    func_149658_d("palamod:thrones/farmer");
  }
  
  public boolean func_149727_a(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
    if (!JobsBridge.canUse(par5EntityPlayer, new ItemStack(BlocksRegistry.FARMER_THRONE)))
      return false; 
  ...
  public void func_149689_a(World world, int x, int y, int z, EntityLivingBase player, ItemStack item) {
    ...
    TileEntityFarmerThrone tile = (TileEntityFarmerThrone)world.func_147438_o(x, y, z);
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    if (!world.field_72995_K) {
      TileEntityFarmerThrone te = (TileEntityFarmerThrone)world.func_147438_o(x, y, z);
      if (te != null) {
  ...
  public int func_149645_b() {
    return JClientProxy.renderFarmerThrone;
  }
  ...
  public TileEntity createTileEntity(World world, int metadata) {
    return (TileEntity)new TileEntityFarmerThrone();
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\ajobs\common\blocks\thrones\BlockFarmerThrone.class
