...
public class BlockHunterThrone extends BlockThroneBase {
  public BlockHunterThrone() {
    func_149663_c("hunter_throne");
    func_149676_a(0.0F, 0.5F, 0.0F, 1.0F, 2.0F, 1.0F);
    func_149658_d("palamod:thrones/hunter");
  }
  
  public boolean func_149727_a(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9) {
    if (!JobsBridge.canUse(par5EntityPlayer, new ItemStack(BlocksRegistry.HUNTER_THRONE)))
      return false; 
  ...
  public void func_149689_a(World world, int x, int y, int z, EntityLivingBase player, ItemStack item) {
    ...
    TileEntityHunterThrone tile = (TileEntityHunterThrone)world.func_147438_o(x, y, z);
  ...
  public void func_149681_a(World world, int x, int y, int z, int meta, EntityPlayer player) {
    if (!world.field_72995_K) {
      TileEntityHunterThrone te = (TileEntityHunterThrone)world.func_147438_o(x, y, z);
      if (te != null) {
  ...
  public TileEntity createTileEntity(World world, int metadata) {
    return (TileEntity)new TileEntityHunterThrone();
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palamod\modules\ajobs\common\blocks\thrones\BlockHunterThrone.class
