...
public class TextFieldNode extends TextFieldNode {
  private static final TextInfo TEXT_INFO = TextInfo.create((IFont)PaladiumFont.MONTSERRAT_SEMI_BOLD, 16.0F, new Color(1.0F, 1.0F, 1.0F, 0.5F));
  ...
  public static TextFieldNode create(double x, double y, double width) {
    return new TextFieldNode(x, y, width, 46.0D);
  }
  ...
  @NonNull
  public <T extends TextFieldNode> T borderColor(@NonNull Color color) {
    if (color == null)
      throw new NullPointerException("color is marked non-null but is null"); 
...
/* Location:              E:\Paladium\!\fr\paladium\paladiumui\kit\textfield\TextFieldNode.class
