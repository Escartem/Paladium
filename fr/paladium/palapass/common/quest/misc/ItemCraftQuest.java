...
public class ItemCraftQuest extends Quest {
  private static final EnumQuestsType TYPE = EnumQuestsType.ITEM_CRAFT;
  ...
  public static void trigger(EntityPlayer entityPlayer, ItemStack itemStack, int quantity) {
    ...
    for (Quest quest : quests) {
      ...
      if (itemStack.func_77969_a(itemStackQuest) || (itemStack.func_77984_f() && itemStack.func_77973_b().equals(itemStackQuest.func_77973_b()))) {
        String craftItemProgressMessage = PalapassTranslateEnum.CRAFT_ITEM_PROGRESS.textOrDefault(entityPlayer, "Crafter " + itemStack
            
            .func_82833_r() + " §c{VALUE}/{QUANTITY}", new Object[] { itemStack
              .func_82833_r() });
        quest.questProgress(entityPlayer, quantity, craftItemProgressMessage);
      } 
    } 
  }
}
...
/* Location:              E:\Paladium\!\fr\paladium\palapass\common\quest\misc\ItemCraftQuest.class
