...
public class ItemEnchantQuest extends Quest {
  private static final EnumQuestsType TYPE = EnumQuestsType.ITEM_ENCHANT;
  ...
  public static void trigger(EntityPlayer entityPlayer, ItemStack itemStack, int quantity) {
    ...
    for (Quest quest : quests) {
      ...
      if (itemStack.func_77969_a(itemStackQuest) || (itemStack.func_77984_f() && itemStack.func_77973_b().equals(itemStackQuest.func_77973_b()))) {
        String enchantItemProgressMessage = PalapassTranslateEnum.ENCHANT_ITEM_PROGRESS.textOrDefault(entityPlayer, "Enchanter " + itemStack
            
            .func_82833_r() + " §c{VALUE}/{QUANTITY}", new Object[] { itemStack
              .func_82833_r() });
        quest.questProgress(entityPlayer, quantity, enchantItemProgressMessage);
      } 
    } 
  }
}
...
/* Location:              E:\Paladium\!\fr\paladium\palapass\common\quest\misc\ItemEnchantQuest.class
