...
public class FactionEnterClaimQuest extends Quest {
  private static final EnumQuestsType TYPE = EnumQuestsType.FACTION_ENTER_CLAIM;
  ...
  public static void trigger(EntityPlayer entityPlayer) {
    ...
    for (Quest quest : quests) {
      String progressMessage = PalapassTranslateEnum.FACTION_ENTER_CLAIM_PROGRESS.textOrDefault(entityPlayer, "Entrer dans un claim ennemi §c{VALUE}/{QUANTITY}");
...
/* Location:              E:\Paladium\!\fr\paladium\palapass\common\quest\factions\FactionEnterClaimQuest.class
