...
public class GrinderCraftQuest extends Quest {
  private static final EnumQuestsType TYPE = EnumQuestsType.GRINDER_CRAFT;
  ...
  public static void trigger(EntityPlayer entityPlayer, ItemStack itemStack, int quantity) {
    ...
    for (Quest quest : quests) {
      ...
      if (itemStack.func_77969_a(itemStackQuest) || (itemStack.func_77984_f() && itemStack.func_77973_b().equals(itemStackQuest.func_77973_b())))
        quest.questProgress(entityPlayer, quantity, PalapassTranslateEnum.CRAFT_IN_GRINDER_PROGRESS.textOrDefault(entityPlayer, "Crafter " + itemStack.func_82833_r() + " dans le grinder §c{VALUE}/{QUANTITY}", new Object[] { itemStack.func_82833_r() })); 
    } 
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palapass\common\quest\palamod\GrinderCraftQuest.class
