...
public class PalamachineCraftQuest extends Quest {
  private static final EnumQuestsType TYPE = EnumQuestsType.PALAMACHINE_CRAFT;
  ...
  public static void trigger(EntityPlayer entityPlayer, ItemStack itemStack, int quantity) {
    ...
    for (Quest quest : quests) {
      ...
      if (itemStack.func_77969_a(itemStackQuest) || (itemStack.func_77984_f() && itemStack.func_77973_b().equals(itemStackQuest.func_77973_b())))
        quest.questProgress(entityPlayer, quantity, PalapassTranslateEnum.PALAMACHINE_CRAFT_PROGRESS.textOrDefault(entityPlayer, "Crafter dans la PalaMachine §c{VALUE}/{QUANTITY}")); 
    } 
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palapass\common\quest\palamod\PalamachineCraftQuest.class
