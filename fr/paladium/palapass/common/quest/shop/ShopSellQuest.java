...
public class ShopSellQuest extends Quest {
  private static final EnumQuestsType TYPE = EnumQuestsType.SHOP_SELL;
  ...
  public static void trigger(EntityPlayer entityPlayer, ItemStack itemStack, int quantity) {
    ...
    for (Quest quest : quests) {
      ...
      if (itemStack.func_77969_a(itemStackQuest) || (itemStack.func_77984_f() && itemStack.func_77973_b().equals(itemStackQuest.func_77973_b())))
        quest.questProgress(entityPlayer, quantity, PalapassTranslateEnum.SELL_ITEM_SHOP_PROGRESS.textOrDefault(entityPlayer, "Vendre " + itemStack.func_82833_r() + " au shop §c{VALUE}/{QUANTITY}", new Object[] { itemStack.func_82833_r() })); 
    } 
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palapass\common\quest\shop\ShopSellQuest.class
