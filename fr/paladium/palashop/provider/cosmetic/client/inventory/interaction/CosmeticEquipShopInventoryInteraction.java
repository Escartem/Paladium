...
public class CosmeticEquipShopInventoryInteraction implements IShopInventoryInteraction {
  ...
  public void execute(@NonNull IShopInventoryElement element) {
    if (element == null)
      throw new NullPointerException("element is marked non-null but is null"); 
    ICosmeticClient cosmetic = (ICosmeticClient)element;
    (new CSPacketEquipCosmetic(cosmetic.getFactory().getId(), cosmetic.getId(), -1)).send();
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palashop\provider\cosmetic\client\inventory\interaction\CosmeticEquipShopInventoryInteraction.class
