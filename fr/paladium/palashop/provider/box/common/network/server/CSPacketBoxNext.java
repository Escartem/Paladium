...
public class CSPacketBoxNext extends ForgePacket {
  @PacketData
  ...
  public CSPacketBoxNext() {}
  
  public CSPacketBoxNext(int entityId, int spinIndex) {
