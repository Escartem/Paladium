...
class null implements NodeDrawCallback<ItemNode> {
  ...
  public void apply(@NonNull ItemNode node, double mouseX, double mouseY, float partialTicks) {
    ...
    if (mc.field_71466_p == null || mc.func_110434_K() == null || ItemShopRenderer.access$000() == null || node.getItem() == null || node.getItem().func_77973_b() == null)
      return; 
    Color.reset();
    ...
    GLContext.matrix(() -> {
          ...
          (ItemShopRenderer.access$000()).field_77023_b = -49.0F;
          (ItemShopRenderer.access$000()).field_77024_a = true;
          ItemShopRenderer.access$000().func_82406_b(mc.field_71466_p, mc.func_110434_K(), node.getItem(), 0, 0);
          if (node.isStackSize())
            ItemShopRenderer.access$000().func_77021_b(mc.field_71466_p, mc.func_110434_K(), node.getItem(), 0, 0); 
          GL11.glPopMatrix();
...
/* Location:              E:\Paladium\!\fr\paladium\palashop\provider\item\rende\\ui\ItemShopRenderer$1.class
