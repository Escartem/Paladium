...
public class ShopSlideDownTransition extends Transition {
  public ShopSlideDownTransition() {
  ...
  public static class PushOutTransition extends Transition.Out {
    ...
    public void start() {
      Timeline timeline = getAnimator().sequence(1000.0F, 0.0F, (TweenEquation)TweenEquations.QUART_IN).getTimeline();
      start(timeline);
    }
...
/* Location:              E:\Paladium\!\fr\paladium\palashop\clien\\ui\kit\transition\ShopSlideDownTransition.class
