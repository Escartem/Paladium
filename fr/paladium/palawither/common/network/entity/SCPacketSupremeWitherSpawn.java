...
public class SCPacketSupremeWitherSpawn extends ForgePacket {
  @PacketData
  private String name;
  ...
  public SCPacketSupremeWitherSpawn() {}
  
  public SCPacketSupremeWitherSpawn(String name, int entityId) {
    this.name = name;
    this.entityId = entityId;
  }
  
  public SCPacketSupremeWitherSpawn(@NonNull EntitySupremeWither wither) {
    if (wither == null)
  ...
  public void processClient() {
    ...
    entityClientPlayerMP.func_146105_b((IChatComponent)new ChatComponentText("§8[§6Paladium§8] §8Le §4§l" + TTT.format(I18n.func_135052_a(this.name, new Object[0]), new Object[0]).toUpperCase() + " §8à §8terminé §8de §4§lCHARGER§8, §8plus §8rien §8ne §8pourra §8l'arrêter §8!"));
    entityClientPlayerMP.func_146105_b((IChatComponent)new ChatComponentText(""));
    ...
    for (Object entity : ((EntityPlayer)entityClientPlayerMP).field_70170_p.field_72996_f) {
      ...
      if (witherAnimatable == null)
        continue; 
      witherAnimatable.forceAnimation("spawn", false);
    } 
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palawither\common\network\entity\SCPacketSupremeWitherSpawn.class
