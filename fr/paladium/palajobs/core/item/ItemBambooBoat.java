...
public class ItemBambooBoat extends ItemBoat {
  public ItemBambooBoat(String unlocalized) {
  ...
  public ItemStack func_77659_a(ItemStack item, World world, EntityPlayer player) {
    ...
    if (jobsPlayer != null && 
      JobsManager.getInstance().canUseCraft(player, jobsPlayer, new ItemStack(ItemsRegistry.BAMBOO_BOAT)) != null)
      return item; 
    float f = 1.0F;
    ...
    if (movingobjectposition.field_72313_a == MovingObjectPosition.MovingObjectType.BLOCK) {
      ...
      if (world.func_147439_a(i, j, k) == Blocks.field_150431_aC)
        j--; 
      EntityBambooBoat entityboat = new EntityBambooBoat(world, (i + 0.5F), (j + 1.0F), (k + 0.5F));
...
/* Location:              E:\Paladium\!\fr\paladium\palajobs\core\item\ItemBambooBoat.class
