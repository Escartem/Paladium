...
public abstract class AnimatedEntityMob extends EntityMob implements IAnimatedEntity, IAnimatable, IAnimationTickable {
  private final AnimationFactory animationFactory = new AnimationFactory(this);
  
  private final EnumMap<AnimationType, String[]> defaultAnimations = (EnumMap)new EnumMap<>(AnimationType.class);
  
  private float animationTransition = 10.0F;
  ...
  public AnimatedEntityMob(World world, double x, double y, double z) {
    this(world);
    func_70634_a(x, y, z);
  }
  ...
  public void func_70071_h_() {
    ...
    if (!this.field_70170_p.field_72995_K)
      if (!isMovingAnimation() && (func_70781_l() || (func_70661_as().func_75505_d() != null && !func_70661_as().func_75505_d().func_75879_b()))) {
        this.field_70180_af.func_75692_b(31, Byte.valueOf((byte)1));
      } else if (isMovingAnimation() && !func_70781_l() && (func_70661_as().func_75505_d() == null || func_70661_as().func_75505_d().func_75879_b())) {
  ...
  public void func_70609_aI() {
    ...
    if (!this.deathAnimation) {
      playAnimation(func_70673_aS(), getDefaultAnimation(AnimationType.DEATH), 1500L, false).setCallback(e -> e.func_70106_y());
      this.deathAnimation = true;
    } 
  }
  
  public void func_70665_d(DamageSource source, float value) {
    if (!this.field_70170_p.field_72995_K && value > 0.0F && !func_85032_ar() && this.defaultAnimations.containsKey(AnimationType.HURT) && !isAnimated() && !isAnimated() && !isMovingAnimation() && !isDeathAnimation())
  ...
  public AnimatedEntityMob setDefaultAnimation(AnimationType type, String... name) {
  ...
  public void registerControllers(AnimationData data) {
    data.addAnimationController(new AnimationController(this, "animationController", this.animationTransition, this::predicateAnimations));
  }
  ...
  public void setAnimationTransition(float animationTransition) {
...
/* Location:              E:\Paladium\!\fr\paladium\palajobs\core\entity\gecko\AnimatedEntityMob.class
