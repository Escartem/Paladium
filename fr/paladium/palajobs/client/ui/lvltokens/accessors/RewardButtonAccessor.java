...
public class RewardButtonAccessor implements TweenAccessor<ButtonJobRewardTokenSelector> {
  ...
  public int getValues(ButtonJobRewardTokenSelector target, int tweenType, float[] returnValues) {
    switch (tweenType) {
      case 0:
  ...
  public void setValues(ButtonJobRewardTokenSelector target, int tweenType, float[] newValues) {
    switch (tweenType) {
      case 0:
...
/* Location:              E:\Paladium\!\fr\paladium\palajobs\clien\\ui\lvltokens\accessors\RewardButtonAccessor.class
