...
public class JobsProgressNode extends AClickableNode {
  ...
  public JobsProgressNode(double x, double y, double size, JobAdvancement job) {
  ...
  public JobsProgressNode setShowLevel(boolean showLevel) {
