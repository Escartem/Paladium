package fr.paladium.palacommunityevent.common.utils;
...
public class JsonUtils {
  ...
  public static Object getFileObject(String fileName, Type clazz) throws Exception {
    String content = new String(Files.readAllBytes(Paths.get(ServerProxy.getInstance().getConfigDirectory().getAbsolutePath() + File.separator + fileName, new String[0])));
...
/* Location:              E:\Paladium\!\fr\paladium\palacommunityevent\commo\\utils\JsonUtils.class
