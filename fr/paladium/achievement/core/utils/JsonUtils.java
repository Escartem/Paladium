...
public class JsonUtils {
  ...
  public static Object getFileObject(String fileName, Type clazz) throws Exception {
    String content = new String(Files.readAllBytes(Paths.get(AchievementMod.getServer().getConfigDirectory().getAbsolutePath() + File.separator + fileName, new String[0])));
...
/* Location:              E:\Paladium\!\fr\paladium\achievement\cor\\utils\JsonUtils.class
