...
public class BBPacketRPGDungeonSynchronizedUIMousePress extends ForgePacket {
  @PacketData
  ...
  public BBPacketRPGDungeonSynchronizedUIMousePress() {}
  
  public BBPacketRPGDungeonSynchronizedUIMousePress(String leader, String uiClass, double mouseX, double mouseY, ClickType clickType) {
    this.leader = leader;
  ...
  public void processClient() {
    try {
      ...
      if (!dungeonUI.isMain(this.leader))
        return; 
      dungeonUI.onRemoteMousePressed(this.mouseX, this.mouseY, this.clickType);
    } catch (Exception e) {
      e.printStackTrace();
    } 
  }
  ...
  public void processServer(EntityPlayerMP player) {
    ...
    world.getOnlinePlayers().forEach(p -> (new BBPacketRPGDungeonSynchronizedUIMousePress(UUIDUtils.toString((Entity)player), this.uiClass, this.mouseX, this.mouseY, this.clickType)).send((EntityPlayerMP)p));
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palarpg\module\dungeon\common\networ\\ui\sync\BBPacketRPGDungeonSynchronizedUIMousePress.class
