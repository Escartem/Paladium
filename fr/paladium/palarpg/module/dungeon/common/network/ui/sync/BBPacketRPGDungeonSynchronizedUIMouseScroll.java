...
public class BBPacketRPGDungeonSynchronizedUIMouseScroll extends ForgePacket {
  @PacketData
  ...
  public BBPacketRPGDungeonSynchronizedUIMouseScroll() {}
  
  public BBPacketRPGDungeonSynchronizedUIMouseScroll(String leader, String uiClass, double mouseX, double mouseY, int value) {
    this.leader = leader;
  ...
  public void processClient() {
    try {
      ...
      if (!dungeonUI.isMain(this.leader))
        return; 
      dungeonUI.onRemoteMouseScrolled(this.mouseX, this.mouseY, this.value);
    } catch (Exception e) {
      e.printStackTrace();
    } 
  }
  ...
  public void processServer(EntityPlayerMP player) {
    ...
    world.getOnlinePlayers().forEach(p -> (new BBPacketRPGDungeonSynchronizedUIMouseScroll(UUIDUtils.toString((Entity)player), this.uiClass, this.mouseX, this.mouseY, this.value)).send((EntityPlayerMP)p));
  }
}


/* Location:              E:\Paladium\!\fr\paladium\palarpg\module\dungeon\common\networ\\ui\sync\BBPacketRPGDungeonSynchronizedUIMouseScroll.class
