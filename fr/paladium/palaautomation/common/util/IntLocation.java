...
public class IntLocation {
  ...
  public static IntLocation of(int[] coords) {
    return new IntLocation(coords[0], coords[1], coords[2]);
  }
...
/* Location:              E:\Paladium\!\fr\paladium\palaautomation\commo\\util\IntLocation.class
