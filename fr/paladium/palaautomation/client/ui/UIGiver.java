...
public class UIGiver extends UI implements IAutomationUI {
  ...
  public UIGiver(TileEntityGiver tile) {
    super((Container)new ContainerGiver(tile, (EntityPlayer)(Minecraft.func_71410_x()).field_71439_g));
    this.tile = tile;
  ...
  public void init() {
    ...
    slots.forEach(slot -> {
          if (slot.field_75224_c instanceof TileEntityGiver) {
...
/* Location:              E:\Paladium\!\fr\paladium\palaautomation\clien\\ui\UIGiver.class
